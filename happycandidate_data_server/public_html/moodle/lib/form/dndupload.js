...
M.form_dndupload.init = function(Y, options) {
    var dnduploadhelper = {
        ...
        url: M.cfg.wwwroot + '/repository/repository_ajax.php?action=upload'+'&'+M.cfg.currentsessionvar+'='+M.cfg.currentsessionvalue,
    ...
    Y.extend(dnduploader, Y.Base, {
        ...
        api: M.cfg.wwwroot+'/repository/repository_ajax.php'+'?'+M.cfg.currentsessionvar+'='+M.cfg.currentsessionvalue,
