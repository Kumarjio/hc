    ...
    public function login_info($withlinks = null) {
        ...
        if (empty($course->id)) {
            ...
            if ($withlinks) {
                ...
                $username = "<a href=\"$CFG->wwwroot/user/profile.php?id=$USER->id&$CFG->currentsessionvar=$CFG->currentsessionvalue\" title=\"$linktitle\">$fullname</a>";
            } else {
                $username = $fullname;
            }
            ...
            if (isguestuser()) {
                ...
                if ($withlinks) {
                    $loggedinas .= " (<a href=\"$CFG->wwwroot/login/logout.php?sesskey=".sesskey()."&$CFG->currentsessionvar=$CFG->currentsessionvalue\">".get_string('logout').'</a>)';
                }
            }
        } else {
