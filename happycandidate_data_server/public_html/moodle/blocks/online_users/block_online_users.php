        ...
        if (!empty($users)) {
            ...
            foreach ($users as $user) {
                ...
                if (isguestuser($user)) {
                    ...
                    $this->content->text .= '<a href="'.$CFG->wwwroot.'/user/view.php?id='.$user->id.'&amp;course='.$this->page->course->id.'&'.$CFG->currentsessionvar.'='.$CFG->currentsessionvalue.'" title="'.$timeago.'">';
                ...
                if ($canshowicon and ($USER->id != $user->id) and !isguestuser($user)) {  // Only when logged in and messaging active etc
                    ...
                    $anchortag = '<a href="'.$CFG->wwwroot.'/message/index.php?id='.$user->id.'&'.$CFG->currentsessionvar.'='.$CFG->currentsessionvalue.'" title="'.get_string('messageselectadd').'">'.$anchortagcontents .'</a>';
