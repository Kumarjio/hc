...
class CVSetting extends DatabaseObject{
	...
	protected static $db_fields = array('id', 'fk_employee_id', 'cv_title','cv_description','cv_file_name','cv_file_type','cv_file_exe','cv_file_size','cv_file_path','original_name','cv_status','default_cv','year_experience','highest_education','salary_range','availability','start_date','positions','recent_job_title','recent_employer','recent_industry_work','recent_career_level','look_job_title','look_job_title2','look_job_type','look_job_status','city','county', 'state_province','country','are_you_auth','willing_to_relocate','willing_to_travel','additional_notes','key_skills','no_views','created_at','modified_at');
