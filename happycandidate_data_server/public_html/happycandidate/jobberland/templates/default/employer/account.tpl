  ...
  <form action="" method="post" enctype="multipart/form-data">
    ...
    <table width="100%">
		...
		<tr>
            ...
            <td><input type="text" id="txt_first_name" name="txt_first_name" size="25" class="text_field" value="{$fname}" /></td>
        </tr>
		 <tr>
           <td><img src="{$skin_images_path}required.gif" alt="" /></td>
            <td><span class="label">Last Name: </span></td>
            <td><input type="text" id="txt_last_name" name="txt_last_name" size="25" class="text_field" value="{$lname}" /></td>
        </tr>
        <tr>
            <td><img src="{$skin_images_path}required.gif" alt="" /></td>
		...
		<tr>
			...
			<td><input type="text" onchange="fnGetLocationDetailFromZip()" id="txt_pcode" name="txt_pcode" size="10" class="text_field"  value="{$pcode}" />&nbsp;<img style="display:none;" id="loader" name="loader" src="{$BASE_URL}images/loader.gif" /></td>
		</tr>
		...
		<tr id="state">
			...
			<td>
				...
				{ else }
					<input class="text_field required" name="txtstateprovince" id="txtstateprovince" type="text" size="30" maxlength="100" value="{$smarty.session.loc.stateprovince}" />
			   { /if}                
				</div>
			  </td>
		</tr>
		...
		<tr id="locality" style="display:none;">
			...
			<td>
				<div id="city_auto">
				  ...
				  { else }
					<input name="txtcity" id="localityval" type="text" size="30" maxlength="100" value="{$smarty.session.loc.citycode}" />
				  { /if}
