...
<table width="100%" border="0" id="company_table" cellpadding="2" cellspacing="2" >
  ...
  <tr>
   ...
   <tr>
    ...
    <td>
     <input name="txt_cname" type="text" class="text_field" size="80" id="txt_cname" value="{$smarty.session.add_job.compname}" />
...
<table width="100%" border="0" id="job_table" cellpadding="2" cellspacing="2" >
  ...
  <tr valign="top">
    ...
    <td>
      <textarea name="txt_job_req" id="txt_job_req" cols="5" rows="20" class="text_field required" >{$smarty.session.add_job.job_req}</textarea>
       <br />{lang mkey='info' skey='job_desc_cha_all'} 
    </td>
  </tr>
    ...
    <td>
      <table width="100%">
        <tr>
          <td>Postal Code:</td>
          <td>
           <input type="text" onchange="fnGetLocationDetailFromZip()" id="txt_pcode" name="txt_pcode" size="30" class="text_field"  value="{$smarty.session.loc.pcode}" /> &nbsp;  <img style="display:none;" id="loader" name="loader" src="{$BASE_URL}images/loader.gif" />
          </td>
        </tr>
