<?php /* Smarty version 2.6.26, created on 2015-10-27 11:32:17
         compiled from admin/view_year_experience.tpl */ ?>
...
<table>
    ...
    <tr>
      <td></td>
      <td></td>
      <td><input type="submit" name="bt_add" value="Add Experience" class="button" /></td>
    </tr>
...
<div class="header">Years of Experience </div>
...
<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('comptcounter', ob_get_contents());ob_end_clean(); ?>
  ...
  <tr>
    ...
    <td><?php echo $this->_tpl_vars['i']['experience_name']; ?>
</td>
...
"  onclick="if ( !confirm('Are you sure you wont to delete this Experience name') ) return false;" >
        <img src="<?php echo $this->_tpl_vars['skin_images_path']; ?>
