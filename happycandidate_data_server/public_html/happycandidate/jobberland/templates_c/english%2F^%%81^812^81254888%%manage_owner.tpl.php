<?php /* Smarty version 2.6.26, created on 2015-10-27 12:35:13
         compiled from admin/manage_owner.tpl */ ?>
<!--<div class="header">Manage Owners </div>-->
...
<br />
  <table width="100%" cellpadding="5" cellspacing="1" class="tb_table">
    <tr>
      ...
      <td class="tb_col_head">Portal</td>
...
?>
    ...
    <tr>
      <td class="tb_col_data"><?php echo $this->_tpl_vars['i']['rowncount']; ?>
...
" 
      ...
      <td class="tb_col_data"><?php echo $this->_tpl_vars['i']['portalname']; ?>
</td>
     <!-- <td class="tb_col_data"><?php echo $this->_tpl_vars['i']['cv_qty']; ?>
      ...
      <td class="tb_col_data"><?php if ($this->_tpl_vars['i']['is_active'] == '1'): ?> Active<?php else: ?>Not Active<?php endif; ?></td>
          </tr>
