<?php /* Smarty version 2.6.26, created on 2017-11-20 15:22:33
         compiled from admin/manage_approved.tpl */ ?>
<div class="header">Approved Listings</div>
...
<br />
  <table width="100%" cellpadding="5" cellspacing="1" class="tb_table">
    <tr>
	  ...
	  <td class="tb_col_head">For Portal</td>
...
&amp;action=deactivate">Inactivate</a>
<?php else: ?>
	<a href="?id=<?php echo $this->_tpl_vars['i']['id']; ?>
