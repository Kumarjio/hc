<?php /* Smarty version 2.6.26, created on 2015-10-22 20:34:37
         compiled from admin/view_education.tpl */ ?>
...
<br /><br />
<div class="header">Update educations </div>
...
<div class="header">Educations </div>
...
<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('comptcounter', ob_get_contents());ob_end_clean(); ?>
  <tr>
    ...
    <td><?php echo $this->_tpl_vars['i']['education_name']; ?>
</td>
...
"  onclick="if ( !confirm('Are you sure you wont to delete this Education name') ) return false;" >
        <img src="<?php echo $this->_tpl_vars['skin_images_path']; ?>
