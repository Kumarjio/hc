<?php /* Smarty version 2.6.26, created on 2017-11-20 15:22:36
         compiled from admin/manage_pending.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'admin/manage_pending.tpl', 5, false),)), $this); ?>
<div class="header">Pending Listings</div>

<?php if ($this->_tpl_vars['message'] != ""): ?> <?php echo $this->_tpl_vars['message']; ?>
 <?php endif; ?>

<?php if (is_array ( $this->_tpl_vars['manage_lists'] ) && $this->_tpl_vars['manage_lists'] != "" && ((is_array($_tmp=$this->_tpl_vars['manage_lists'])) ? $this->_run_mod_handler('count', true, $_tmp) : count($_tmp)) != 0): ?>
