<?php /* Smarty version 2.6.26, created on 2017-07-01 00:26:25
         compiled from admin/manage_employer_active.tpl */ ?>
...
" target="_blank"><?php echo $this->_tpl_vars['i']['employer_portal_name']; ?>
      ...
      <td class="tb_col_data"><div style="float:left;width:100px;word-wrap:break-word;"><?php echo $this->_tpl_vars['i']['email_address']; ?>
</div></td>
            ...
            <ul>
               ...
               <li><a href="#">Action</a>
                ...
                <ul id="user_nav">
                    ...
                    <li><a onclick="return fnRedirect(this);false;" href="<?php echo $this->_tpl_vars['i']['login_as_url']; ?>
">Login as User</a></li>

					<?php if ($this->_tpl_vars['i']['is_active'] == 'Y'): ?>

                        <li><a href="?id=<?php echo $this->_tpl_vars['i']['id']; ?>
&amp;action=deactivate">Inactivate</a></li>
