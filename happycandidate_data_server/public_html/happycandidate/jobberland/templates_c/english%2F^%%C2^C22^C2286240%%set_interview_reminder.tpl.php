<?php /* Smarty version 2.6.26, created on 2015-11-23 18:06:46
         compiled from set_interview_reminder.tpl */ ?>
			...
			<div style="margin-bottom:0;padding:0;">&nbsp;</div>
				...
				<div style="width:60%;float:left;">
					<span style="margin-left:5%;">
						...
						<input type="hidden" name="participant_id" id="participant_id" value="<?php echo $this->_tpl_vars['intCandidateId']; ?>
" />
						<input type="hidden" name="organization_type" id="organization_type" value="Portal" />
						<input type="hidden" name="organization_head_id" id="organization_head_id" value="<?php echo $this->_tpl_vars['intPortId']; ?>
" />
						<input type="hidden" name="event_subject_type" id="event_subject_type" value="Job" />
						<input type="hidden" name="event_subject_id" id="event_subject_id" value="<?php echo $this->_tpl_vars['intJobId']; ?>
" />
			...
			<div style="width:100%;float:left;">
				...
				<div style="width:60%;float:left;">
					<span style="margin-left:5%;">
						<textarea name="event_dsec" id="event_dsec" class="text ui-widget-content ui-corner-all validate[required]">Your Interview for the post of <?php echo $this->_tpl_vars['job_title']; ?>
 with <?php echo $this->_tpl_vars['company_name']; ?>
</textarea>
			...
			<div style="width:100%;float:left;">
				...
				<div style="width:60%;float:left;">
					<span style="margin-left:5%;">
						<input type="text" name="event_date_time" id="event_date_time" class="text ui-widget-content ui-corner-all validate[required]" />						<span id="eventdatetimeerror" class="ui-state-error" style="display:none;"></span>
					</span>
				</div>	
			</div>
...
" type="text" name="event_contact_name" id="event_contact_name" class="text ui-widget-content ui-corner-all validate[required]" />
