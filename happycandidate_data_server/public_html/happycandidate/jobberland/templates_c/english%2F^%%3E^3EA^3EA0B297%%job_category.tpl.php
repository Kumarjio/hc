<?php /* Smarty version 2.6.26, created on 2013-10-30 07:42:38
         compiled from job_category.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'lang', 'job_category.tpl', 2, false),array('modifier', 'strip_tags', 'job_category.tpl', 2, false),)), $this); ?>
<?php if (is_array ( $this->_tpl_vars['cat_by_job'] ) && $this->_tpl_vars['cat_by_job'] != ""): ?>    
	<div class="header"> <?php echo smarty_function_lang(array('mkey' => 'header','skey' => 'browse_by_3_sub'), $this);?>
 <?php echo ((is_array($_tmp=$this->_tpl_vars['cat_name'])) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)); ?>
</div>


    <ul class="browse">
    <?php $_from = $this->_tpl_vars['cat_by_job']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
category/<?php echo $this->_tpl_vars['cat_var_name']; ?>
