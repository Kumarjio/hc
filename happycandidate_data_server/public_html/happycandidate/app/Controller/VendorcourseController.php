 ...
 */
class VendorcourseController extends AppController {
 ...
 */
	...
	public function search($strKeywordSearch)
	{
		...
		$this->Session->write('strCancelUrl',Router::url(array('controller'=>'vendorcourse','action'=>'index'),true));
		...
		$this->Paginator->settings = array(
			'Resources' => array(
				'limit' => 20,
				'conditions' => array('product_name'=>$strKeywordSearch,'product_type'=>'Course','created_by'=>$arrLoggedUser['vendor_id'],'product_publish_status'=>'1')
			)
		);
	...
	public function draftsearch($strKeywordSearch)
	{
		$arrLoggedUser = $this->Auth->user();
		$strActionScript = '<script type="text/javascript" src="'.Router::url('/js/resourcecourse_index.js').'"></script>';
		$strActionScript .= '<script type="text/javascript" src="'.Router::url('/js/jquery/jquery.tablesorter.js').'"></script>';
		$this->set('strActionScript',$strActionScript);
		$this->Session->write('strCancelUrl',Router::url(array('controller'=>'vendorcourse','action'=>'drafted'),true));
		...
		$this->Paginator->settings = array(
			'Resources' => array(
				'limit' => 20,
				'conditions' => array('product_name'=>$strKeywordSearch,'product_type'=>'Course','created_by'=>$arrLoggedUser['vendor_id'],'product_draft_status'=>'1')
			)
		);
	...
	public function moderationsearch($strKeywordSearch)
	{
		$arrLoggedUser = $this->Auth->user();
		$strActionScript = '<script type="text/javascript" src="'.Router::url('/js/resourcecourse_index.js').'"></script>';
		$strActionScript .= '<script type="text/javascript" src="'.Router::url('/js/jquery/jquery.tablesorter.js').'"></script>';
		$this->set('strActionScript',$strActionScript);
		$this->Session->write('strCancelUrl',Router::url(array('controller'=>'vendorcourse','action'=>'moderation'),true));
		...
		$this->Paginator->settings = array(
			'Resources' => array(
				'limit' => 20,
				'conditions' => array('product_name'=>$strKeywordSearch,'product_type'=>'Course','created_by'=>$arrLoggedUser['vendor_id'],'product_moderation_status'=>'1')
			)
		);
	...
	public function index() 
	{
		...
		$strActionScript = '<script type="text/javascript" src="'.Router::url('/js/vendorcourse_index.js').'"></script>';
		$strActionScript .= '<script type="text/javascript" src="'.Router::url('/js/jquery/jquery.tablesorter.js').'"></script>';
		$this->set('strActionScript',$strActionScript);
		$this->Session->write('strCancelUrl',Router::url(array('controller'=>'content','action'=>'index'),true));
		if($this->request->is('Post') && ($this->request->data['filter_on']))
		{
			...
			$this->redirect(array('controller'=>'vendorcourse','action'=>'search',$strProductFilterKeyword));
		}
		...
		$this->Resources->recursive = 0;
		$this->Paginator->settings = array(
			'conditions' => array('product_type' => 'Course','created_by'=>$arrLoggedUser['vendor_id'],'product_publish_status'=>'1'),
			'limit' => 20
		);
	...
	public function manage($intCourseId = "") 
	{
		...
		if($intCourseId)
		{
			...
			{
				$strLmsPath = Configure::read('Lms.courseview')."?usert_type_request=admin&id=".$arrCourseDetail[0]['Resources']['external_content_id'];
	...
	public function moderation() 
	{
		...
		$strActionScript .= '<script type="text/javascript" src="'.Router::url('/js/jquery/jquery.tablesorter.js').'"></script>';
		$this->set('strActionScript',$strActionScript);
		$this->Session->write('strCancelUrl',Router::url(array('controller'=>'content','action'=>'moderation'),true));
		if($this->request->is('Post') && ($this->request->data['filter_on']))
		{
			$strProductFilterKeyword = $this->request->data['product_keyword'];
			
			$this->redirect(array('controller'=>'vendorcourse','action'=>'moderationsearch',$strProductFilterKeyword));
		}
		...
		$this->Resources->recursive = 0;
		$this->Paginator->settings = array(
			'conditions' => array('product_type' => 'Course','created_by'=>$arrLoggedUser['vendor_id'],'product_moderation_status'=>'1'),
			'limit' => 20
		);
	...
	public function drafted() 
	{
		...
		$strActionScript .= '<script type="text/javascript" src="'.Router::url('/js/jquery/jquery.tablesorter.js').'"></script>';
		$this->set('strActionScript',$strActionScript);
		$this->Session->write('strCancelUrl',Router::url(array('controller'=>'content','action'=>'drafted'),true));
		if($this->request->is('Post') && ($this->request->data['filter_on']))
		{
			$strProductFilterKeyword = $this->request->data['product_keyword'];
			
			$this->redirect(array('controller'=>'vendorcourse','action'=>'draftsearch',$strProductFilterKeyword));
		}
		...
		$this->Resources->recursive = 0;
		$this->Paginator->settings = array(
			'conditions' => array('product_type' => 'Course','created_by'=>$arrLoggedUser['vendor_id'],'product_draft_status'=>'1'),
			'limit' => 20
		);
	...
	public function add()
	{
		...
		if($this->request->is('Post'))
		{
			...
			$arrContentData['Resources']['product_name'] = $this->request->data['service_name'];
			$arrContentData['Resources']['product_cost'] = $this->request->data['service_cost'];
			$arrContentData['Resources']['product_type'] = "Course";
			$arrContentData['Resources']['created_by'] = $arrLoggedUser['vendor_id'];
			$arrContentData['Resources']['categoryid'] = $arrLoggedUser['vendor_category_id'];
			
			if($this->request->data['to_moderate'])
			{
				$arrContentData['Resources']['product_publish_status'] = "0";
				$arrContentData['Resources']['product_draft_status'] = "0";
				$arrContentData['Resources']['product_moderation_status'] = "1";
				$arrContentData['Content']['content_status']  = "published";
			}
			else
			{
