 ...
 */
class PortalpreviewController extends AppController {
...
//        Configure::write('debug', 2);
        ...
        if ($intPortalExists) {
            ...
            $strPreviewHomeEditorLink = Router::url('/', true) . "portalpreview/home/" . $arrPortalDetail[0]['Portal']['career_portal_name'];
            $this->set('strHomeEditorLink', $strPreviewHomeEditorLink);
            $strRegister = Router::url(array('controller' => 'portalpreview', 'action' => 'register', $arrPortalDetail[0]["Portal"]["career_portal_name"]), true);
    ...
    public function themepage($intPageId) {
        ...
        $strPreviewHomeEditorLink = Router::url('/', true) . "portalpreview/home/" . $arrPortalThemeDetail['Portal']['career_portal_name'];
        $this->set('strHomeEditorLink', $strPreviewHomeEditorLink);
        $strPreviewRegister = Router::url(array('controller' => 'portalpreview', 'action' => 'register', $arrPortalThemeDetail["Portal"]["career_portal_name"]), true);
        $this->set('strRegister', $strPreviewRegister);
