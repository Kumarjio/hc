 ...
 */
class AdminsprofileController extends AppController 
{
	...
	public function edit()
	{
		...
		if($this->request->is('post'))
		{
			...
			if($this->User->validates())
			{
				...
				$arrAdminDetailPostedData['admin_address1'] = addslashes(trim($this->request->data['User']['address1']));
					...
					if($boolUpdated)
					{
						...
						$boolDetailUpdated = $this->Admin->updateAll(
																			array('Admin.admin_fname' => "'".$arrAdminDetailPostedData['admin_fname']."'",
																				  ...
																				  'Admin.admin_address1'=>"'".$arrAdminDetailPostedData['admin_address1']."'",
