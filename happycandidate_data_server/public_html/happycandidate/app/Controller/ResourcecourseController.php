 ...
 */
class ResourcecourseController extends AppController {
    ...
    public function productdelete($intProductId) {
        ...
        if ($intProductId) {
            ...
            if (is_array($arrCorrectProductId) && (count($arrCorrectProductId) > 0)) {
                ...
                if ($strResourceType == "Course" || $strResourceType == "SkillSoftcourse") {
    ...
    public function search($strKeywordSearch) {
        $strActionScript = '<script type="text/javascript" src="' . Router::url('/js/resourcecourse_index.js') . '"></script>';
        ...
        $this->Session->write('strCancelUrl', Router::url(array('controller' => 'resourcecourse', 'action' => 'index'), true));
        ...
        if($this->request->data['columnName'] == '' && $this->request->data['sort'] == ''){
            ...
            $this->Session->write('column',$columnName);
            $this->Session->write('sort',$sort);
            $this->Session->write('type','search');
//            $this->Session->write('strKeywordSearch',$strKeywordSearch);
        }
        ...
        if ($columnName !='' && $sort !='') {
            ...
            $this->Paginator->settings = array(
                'conditions' => array('product_name' => $strKeywordSearch,'product_type' => 'Course', 'product_publish_status' => '1','column_name'=>$columnName,'order'=>$sort),
                'limit' => 20
            );

            $arrProductContentList = $this->Paginator->paginate('Resources');
            $view->set('arrProductList', $arrProductContentList);
            $strContactLocationHtml = $view->element('sort_course_list');
            $strPaginationHtml = $view->element('sort_pagination',array('column_name'=>$columnName,'sort'=>$sort,'strKeywordSearch'=>$strKeywordSearch));
            ...
            'Resources' => array(
                'limit' => 20,
                'conditions' => array('product_name' => $strKeywordSearch, 'product_type' => 'Course', 'product_publish_status' => '1','column_name'=>$ColumnName[0],'order'=>$Sort[0])
            )
        );
            $arrProductContentList = $this->Paginator->paginate('Resources');
        }
    ...
    public function draftedsearch($strKeywordSearch) {
        $strActionScript = '<script type="text/javascript" src="' . Router::url('/js/resourcecourse_index.js') . '"></script>';
        $strActionScript .= '<script type="text/javascript" src="' . Router::url('/js/jquery/jquery.tablesorter.js') . '"></script>';
        $strActionScript .= '<script type="text/javascript" src="' . Router::url('/js/jquery/jquery.tablesorter.widgets.js') . '"></script>';
        $this->set('strActionScript', $strActionScript);
        ...
        if($this->request->data['columnName'] == '' && $this->request->data['sort'] == ''){
            ...
            $columnName = $this->request->data['columnName'];
            $sort = $this->request->data['sort'];
            $this->Session->write('draftcolumn',$columnName);
            $this->Session->write('draftsort',$sort);
            $this->Session->write('type','draftedsearch');
//            $this->Session->write('strKeywordSearch',$strKeywordSearch);
        }
        ...
        if ($columnName !='' && $sort !='') {
            ...
            $this->Resources->recursive = 0;
            $this->Paginator->settings = array(
                'conditions' => array('product_name' => $strKeywordSearch,'product_type' => 'Course', 'product_draft_status' => '1','column_name'=>$columnName,'order'=>$sort),
                'limit' => 20
            );
            $arrProductContentList = $this->Paginator->paginate('Resources');
            $view->set('arrProductList', $arrProductContentList);
            ...
            $this->Paginator->settings = array(
                'Resources' => array(
                    'limit' => 20,
                    'conditions' => array('product_name' => $strKeywordSearch, 'product_type' => 'Course', 'product_draft_status' => '1','column_name'=>$ColumnName[0],'order'=>$Sort[0])
                )
            );
            $arrProductContentList = $this->Paginator->paginate('Resources');
            $this->set('arrProductList', $arrProductContentList);
    ...
    public function moderatedsearch($strKeywordSearch) {
        $strActionScript = '<script type="text/javascript" src="' . Router::url('/js/resourcecourse_index.js') . '"></script>';
        $strActionScript .= '<script type="text/javascript" src="' . Router::url('/js/jquery/jquery.tablesorter.js') . '"></script>';
        $strActionScript .= '<script type="text/javascript" src="' . Router::url('/js/jquery/jquery.tablesorter.widgets.js') . '"></script>';
        $this->set('strActionScript', $strActionScript);
...
//        moderatedsearch
        if($this->request->data['columnName'] == '' && $this->request->data['sort'] == ''){
            ...
            $columnName = $this->request->data['columnName'];
            $sort = $this->request->data['sort'];
            $this->Session->write('moderatedsearchcolumn',$columnName);
            $this->Session->write('moderatedsearchsort',$sort);
            $this->Session->write('type','moderatedsearch');
//            $this->Session->write('strKeywordSearch',$strKeywordSearch);
        }
        ...
        if ($columnName !='' && $sort !='') {
            ...
            $this->Paginator->settings = array(
                'Resources' => array(
                    'limit' => 20,
                    'conditions' => array('product_name' => $strKeywordSearch, 'product_type' => 'Course', 'product_moderation_status' => '1','column_name'=>$ColumnName[0],'order'=>$Sort[0])
                )
            );
    ...
    public function moderation() {
        ...
        if ($this->request->is('Post') && ($this->request->data['filter_on'])) {
            ...
            $this->redirect(array('controller' => 'resourcecourse', 'action' => 'moderatedsearch', $strProductFilterKeyword));
        }
        ...
        if ($columnName =='' && $sort =='') {
            ...
            $this->Resources->recursive = 0;
            $this->Paginator->settings = array(
                'conditions' => array('product_type' => 'Course', 'product_moderation_status' => '1'),
                'limit' => 20
            );
            $arrProductContentList = $this->Paginator->paginate('Resources');
        }else{
            ...
            $this->Resources->recursive = 0;
            $this->Paginator->settings = array(
                'conditions' => array('product_type' => 'Course', 'product_moderation_status' => '1','column_name'=>$columnName,'order'=>$sort),
                'limit' => 20
            );
            ...
            $view->set('arrProductList', $arrProductContentList);
            $strContactLocationHtml = $view->element('sort_course_list');
            $strPaginationHtml = $view->element('sort_pagination',array('column_name'=>$columnName,'sort'=>$sort));
            if ($arrProductContentList) {
                $arrResponse['status'] = "success";
                $arrResponse['content'] = $strContactLocationHtml;
                $arrResponse['pagidiv'] = $strPaginationHtml;
    ...
    public function drafted() {
        ...
        if ($this->request->is('Post') && ($this->request->data['filter_on'])) {
            ...
            $this->redirect(array('controller' => 'resourcecourse', 'action' => 'draftedsearch', $strProductFilterKeyword));
        }
        ...
        if ($columnName !='' && $sort !='') {
            ...
            $this->Resources->recursive = 0;
            $this->Paginator->settings = array(
                'conditions' => array('product_type' => 'Course', 'product_draft_status' => '1','column_name'=>$columnName,'order'=>$sort),
                'limit' => 20
            );
            ...
            $this->Resources->recursive = 0;
            $this->Paginator->settings = array(
                'conditions' => array('product_type' => 'Course', 'product_draft_status' => '1','column_name'=>$ColumnName[0],'order'=>$Sort[0]),
                'limit' => 20
            );
            $arrProductContentList = $this->Paginator->paginate('Resources');
        }
    ...
    public function index() {
        ...
        if ($this->request->is('Post') && ($this->request->data['filter_on'])) {
            ...
            $this->redirect(array('controller' => 'resourcecourse', 'action' => 'search', $strProductFilterKeyword));
        }
        ...
        if ($columnName != '' && $sort !='') {
            ...
            $this->Resources->recursive = 0;
            $this->Paginator->settings = array(
                'conditions' => array('product_type' => 'Course', 'product_publish_status' => '1','column_name'=>$columnName,'order'=>$sort),
                'limit' => 20
            );
            ...
            $this->Resources->recursive = 0;
            $this->Paginator->settings = array(
                'conditions' => array('product_type' => 'Course', 'product_publish_status' => '1','column_name'=>$ColumnName[0],'order'=>$Sort[0]),
                'limit' => 20
            );
            $arrProductContentList = $this->Paginator->paginate('Resources');
            $this->set('arrProductList', $arrProductContentList);
    ...
    public function addimage() {
        ...
        if ($this->request->is('Post')) {
            ...
            if ($intEditModeId) {
                ...
                if ($boolContentUpdated) {
                    $compMessage = $this->Components->load('Message');
                    $strForMessage = "Update was successfull.";
...
//        Configure::write('debug',2);
        ...
        if ($this->request->is('Post')) {
            ...
            $arrContentData['Resources']['product_name'] = $this->request->data['service_name'];
            $arrContentData['Resources']['product_cost'] = $this->request->data['service_cost'];
            $arrContentData['Resources']['discount_cost'] = $this->request->data['discount_cost'];
            $arrContentData['Resources']['product_type'] = $this->request->data['txtcoursetype'];
            if ($this->request->data['to_publish']) {
                $arrContentData['Resources']['product_publish_status'] = "1";
                $arrContentData['Resources']['product_draft_status'] = "0";
                $arrContentData['Resources']['product_moderation_status'] = "0";
                $arrContentData['Content']['content_status'] = "published";
            } else {
                $arrContentData['Resources']['product_publish_status'] = "0";
                $arrContentData['Resources']['product_draft_status'] = "1";
                $arrContentData['Resources']['product_moderation_status'] = "0";
                $arrContentData['Content']['content_status'] = null;
            }
...
//                if ($arrContentData['Resources']['product_type'] == "Course") {
                $arrContentData['Resources']['external_content_id'] = $this->request->data['external_service_id'];
                $compLms = $this->Components->load('LmsBridge');
                if ($arrContentData['Resources']['external_content_id'] != '') {
                    $arrCourseCreated = $compLms->fnUpdateLmsCourse($arrContentData);
                    $external_id = $arrContentData['Resources']['external_content_id'];
                    $this->loadModel('Content');
                    $isDeleted = $this->Content->deleteAll(array('resource_id' => $intEditModeId), false);
                    ...
                    $arrCourseCreated = $compLms->fnCreateLmsCourse($arrContentData);
                    $external_id = $arrCourseCreated['courseid'];
                    $this->loadModel('Content');
                    $arrContentData['Content']['resource_id'] = $intEditModeId;
                    $arrContentAdded = $this->Content->save($arrContentData);
                }
                ...
                if ($arrCourseCreated['status'] == "success") {
                    $boolContentUpdated = $this->Resources->updateAll(
                            array('product_name' => "'" . $arrContentData['Resources']['product_name'] . "'", 'product_publish_status' => "'" . $arrContentData['Resources']['product_publish_status'] . "'", 'product_draft_status' => "'" . $arrContentData['Resources']['product_draft_status'] . "'", 'product_moderation_status' => "'" . $arrContentData['Resources']['product_moderation_status'] . "'", 'product_type' => "'" . $arrContentData['Resources']['product_type'] . "'", 'product_cost' => "'" . $arrContentData['Resources']['product_cost'] . "'",'discount_cost' => "'" . $arrContentData['Resources']['discount_cost'] . "'", 'external_content_id' => "'" . $external_id . "'"), array('productd_id =' => $intEditModeId)
                    );
                    ...
                    $compMessage = $this->Components->load('Message');
                    $strMessage = $compMessage->fnGenerateMessageBlock($arrCourseCreated['message'], 'error');
                    $arrResponseData['status'] = 'fail';
                    $arrResponseData['message'] = $strMessage;
                    echo json_encode($arrResponseData);
                    exit;
...
//                }
                ...
                $intContentExists = $this->Resources->find('count', array(
                    'conditions' => array('product_name' => $arrContentData['Resources']['product_name'], "product_type" => $arrContentData['Resources']['product_type'])
                ));
                if ($intContentExists) {
                    $compMessage = $this->Components->load('Message');
                    $strMessage = $compMessage->fnGenerateMessageBlock('This Service is already present', 'info');
                    ...
                    // load lms component
                    // send req through lms component to create course
                    // on successful creation create the same in HC system
                    // if not created do not create in HC system as well and give message to try again

                    $compLms = $this->Components->load('LmsBridge');
                    $arrCourseCreated = $compLms->fnCreateLmsCourse($arrContentData);
                    if ($arrCourseCreated['status'] == "success") {
                        $arrContentData['Resources']['external_content_id'] = $arrCourseCreated['courseid'];
                        $boolContentCreated = $this->Resources->save($arrContentData);
                        if ($boolContentCreated) {
                            $intCreatedContentId = $this->Resources->getLastInsertID();
                            $arrResponseData['createdid'] = $intCreatedContentId;
    ...
    public function publishcoursesort() {
        $arrResponse = array();
        $this->autoRender = false;
        // code to get the html content
        $view = new View($this, false);
        ...
        if ($columnName !='' && $sort !='') {
//            $this->loadModel('Resources');
//            $arrProductList = $this->Resources->fnGetPublishCourseSortList($columnName,$sort);
