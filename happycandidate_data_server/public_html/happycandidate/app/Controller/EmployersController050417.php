 ...
 */
	...
	public function availabledomain()
	{
		...
		$dsc_header = array("Authorization: sso-key 9tzdJCoZv8j_WRdGXmNMHk7r6X2rMXrsND:WRdKjWNC7449DB1R2uYtpM","Content-Type:application/json","Accept:application/json");


//echo "https://api.godaddy.com/v1/domains/suggest?query=".$domainname."";
	...
	public function purchase()
	{
		...
		$dsc_header = array("Authorization: sso-key 9tzdJCoZv8j_WRdGXmNMHk7r6X2rMXrsND:WRdKjWNC7449DB1R2uYtpM","Content-Type:application/json","Accept:application/json","X-Shopper-Id:962538");

	//	$dsc_header = array("Content-Type:application/json","Accept:application/json","X-Shopper-Id:136300880");
		$ch = curl_init("https://api.godaddy.com/v1/domains/purchase");
				if ($ch == FALSE) {
						echo "Connecting to createsend failed\n";
				}
				curl_setopt($ch, CURLOPT_HTTPHEADER, $dsc_header);
