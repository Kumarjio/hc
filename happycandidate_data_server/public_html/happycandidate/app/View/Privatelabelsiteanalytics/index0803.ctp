				...
				<div id="analyticsfilter" style="width:100%;float:left;margin-bottom:50px;padding:0;">
					...
					<div id="oldstatistics">
						<div class="analytics-panel">
							...
							<div id="analyticslabelfield" style="width:80%;float:left;margin:0;padding:4px;">
								From Date: <input style="width:15%;" type="text" name="from_date" id="from_date" readonly />&nbsp; To Date: <input style="width:15%;" type="text" name="to_date" id="to_date" readonly />
							</div>
						</div>
						<div class="analytics-panel">
							<div id="analyticslabel" style="width:18%;float:left;margin-right:2%;padding:4px;">
					...
					<div class="analytics-panel" id="portalstatistics" style="display:none;">
						...
						<div id="analyticslabelfield" style="width:80%;float:left;margin:0;padding:4px;">
							<input type="submit" onclick="fnGetEmployerAnalytics(); return false;" name="getanalytics" id="getanalytics" value="Get Analytics" />
							<span id="portal_stat_actions" style="display:none;">&nbsp;<input style="display:none;" id="portal_stat_print" onclick="window.print();return false;" type="submit" name="print" id="print" value="Print" /></span>
						</div>
					</div>
				</div>
			<?php
