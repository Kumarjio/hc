<div class="page-content-wrapper employers-type" style="min-height:500px;">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1>View Job Seeker(s)</h1>
                <div class="tab-row-container">
                    <p>Listed are all view job seekers in your Career Portal</p>
                    ...
                    <button name="export" id="export" type="button" class="btn btn-default btn-md export-btn" onclick="fnExportJobSeekers()" >Export</button>
                </div>
                <div class="tab-row-container">
...
<script type="text/javascript">
	...
	var PortalId = '<?php echo $portalId;?>';
       ...
       alert("strStartDate" + strStartDate + "strEndDate " + strEndDate + "strStatus " + strStatus);
