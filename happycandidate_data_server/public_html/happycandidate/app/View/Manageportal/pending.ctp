    ...
    <div class="container-fluid">
        <div class="row">
            <div class="tab-header">
                <h1>Pending Career Portals</h1>
            </div>
            <div class="tab-search">
                <?php
                $strProductSearchUrl = Router::url(array('controller' => 'manageportal', 'action' => 'pending'), true);
                ?>
                ...
                <table class="tablesorter panel-heading admin-content" id="sort_list">
                    <thead>
                        <tr>
                            ...
                            <th style="width:15%!important;height: 30px !important;">Date Created</th>
                            <!--<th style="width:10%!important; height: 30px !important;">Action</th>-->
                        </tr>
                    </thead>
                    <tbody class="panel-body admin-content">
                    <input type="hidden" id="contentName" value="pending" />
                    ...
                    if (is_array($arrProductList) && (count($arrProductList) > 0)) {
                        ...
                        <tr>
                            <td colspan='7'><span style="margin-left:40%;">No Pending Career Portal</span></td>
                        </tr>
                        <tr>
                            <td colspan='7' class="altrow">&nbsp;</td>
                        </tr>
