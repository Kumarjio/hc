    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="tab-header">
                <h1>Unpublished Career Portals</h1>
            </div>
            <div class="tab-search">
                <?php
                $strProductSearchUrl = Router::url(array('controller' => 'manageportal', 'action' => 'unpublish'), true);
                ?>
            ...
            <div class="tab-row-container resourcetab">
                <table class="tablesorter panel-heading admin-content" id="sort_list">
                    ...
                    <input type="hidden" id="contentName" value="unpublish" />
                    <?php
...
//                            echo '<pre>';print_r($arrContent);
                            ...
                            <tr id="product_list_<?php echo $arrContent['career_portal']['career_portal_id']; ?>">
                                ...
                                <input type="hidden" id="status_<?php echo $arrContent['career_portal']['career_portal_id'];?>" data-attr="<?php echo $arrContent['career_portal']['career_portal_approved'];?>">
                                <td style="width:10%!important; height: 30px !important;">
                                    <a href="javascript:void(0);" id="content_status_<?php echo $arrContent['career_portal']['career_portal_id']; ?>" onclick="return fnChangePortalStatus(this);" class="link-primary">Publish</a>
                                </td>
                            </tr>
                            <?php
                        }
                        ...
                        <tr style="border: none;">
                            <td colspan='7'><span style="margin-left:40%;">No Unpublish Career Portal</span></td>
                        </tr>
                        <tr style="border: none;">
                            <td colspan='7' class="altrow">&nbsp;</td>
                        </tr>
