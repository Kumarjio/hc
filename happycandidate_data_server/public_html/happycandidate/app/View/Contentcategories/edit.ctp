	...
	<div class="row">
		...
		<div class="steps-list">
			...
			<ul class="nav nav-pills tab-list">
				<li class="active">
					<a id="js-phase" data-toggle="pill" href="#phasepart">Categories Panel</a>
				</li>
...
<script type="text/javascript">
	$(document).ready(function () {
		$("#txtEditor").Editor();
		$("#txtEditor").Editor("setText" , '<?php echo stripslashes(htmlspecialchars_decode($arrProductContent['0']['Categories']['content_category_description']));?>');
