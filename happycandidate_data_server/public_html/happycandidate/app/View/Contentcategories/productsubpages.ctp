...
<div class="sub-header"><h2>Product List</h2></div>
<div class="row">
	<div class="col-md-12">
		<?php 
			$strProductIndexUrl = Router::url(array('controller'=>'products','action'=>'index'),true);
		?>
	  ...
	  <tbody>
		<?php
			if(is_array($arrProductList) && (count($arrProductList)>0))
			{
				...
				{
					$intContentCount++;
					$strProductEditUrl = Router::url(array('controller'=>'products','action'=>'edit',$arrContent['Content']['content_id']),true);
					$strPreviewUrl = Router::url(array('controller'=>'products','action'=>'productpreview',$arrContent['Content']['content_id']),true);
					?>
						<tr id="product_list_<?php echo $arrContent['Content']['content_id'];?>">
						  ...
						  <td><?php echo $arrContent['Content']['created_date']; ?></td>
