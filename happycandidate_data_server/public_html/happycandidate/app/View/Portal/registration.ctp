						...
						case "captcha"	: 
										  if($arrFieldInfo['career_portal_registration_form_fields']['career_portal_registration_form_field_enabled'])
										  {
											echo "<li id='captchafield' ".$strCaptchaDisplayStyle.">";
											  ...
											  echo "<input type='text' class='".$strValidationString."' name='data[PortalUser][".$arrFieldInfo['fields_table']['field_name']."]' id='".$arrContactField['fields_table']['field_name']."' placeholder='Please put Above Captcha Code'/>";
											  echo "</li>";
