...
?>
 	...
 	<div class="container-fluid top-bg-v5">
		<a href="#" class="logo-inverse">
			<img src="<?php echo Router::url('/',true);?>images/icon-search-light.png" alt="logo description">
			HR Search
		</a>
		<a href="<?php echo $strLoginUrl;?>" class="link-inverse right-menu-v6">Login</a>
		
		<div id="panel" class="top-slider-v5">
		...
		<div id="flip" class="expanded">
			<img id="arrup" src="<?php echo Router::url('/',true);?>images/arr-up-light.png" alt="image description">
			<img id="arrdown" src="<?php echo Router::url('/',true);?>images/arr-down-light.png" alt="image description">
		</div>
	</div>
    ...
    <div class="container-fluid no-padding">
		...
		<div id="myCarousel" class="carousel slide carousel-clearfix" data-ride="carousel">
		  	...
		  	<div class="carousel-inner carousel-white" role="listbox">
			
				<div class="item active">
					<div class="profiles-container-v5">
