...
$strStartD = date("m/d/Y", strtotime($strStartDate));
$strEndD = date("m/d/Y", strtotime($strEndDate));
?>
                ...
                <div class="tab-row-container">
                    <div class="tab-search">
                        ...
                        <form id="productlistfilterform" name="productlistfilterform" action="<?php echo $strProductSearchUrl; ?>/" method="post" role="form">
                            From Date:
                            <input type="text" id="from_date" name="product_keyword" id="product_keyword" value="<?php echo $strStartD; ?>" name="from_date"><input id="from_date_hid" type="hidden" class="form-control" name="from_date_hid" value="<?php echo $strStartDate; ?>">&nbsp;
                            To Date:
                            <input type="text" id="to_date" name="product_keyword" id="product_keyword" value="<?php echo $strEndD; ?>" name="to_date"><input id="to_date_hid" type="hidden" class="form-control" name="to_date_hid" value="<?php echo $strEndDate; ?>">&nbsp;
                            ...
                            <button name="export" id="export" type="button" class="btn btn-default btn-md" onclick="fnExportCandidateOrder()" >Export</button>
                        </form>
                    </div>
                            ...
                            <table>
                                ...
                                if (is_array($arrProductList) && (count($arrProductList) > 0)) {
                                    ...
                                    foreach ($arrProductList as $arrContent) {
                                        ...
                                        <tr >
                                            ...
                                            <td>
                                                <div class="user-title">
                                                    <a href="javascript:void(0);" id="task1" class="username-clickable"><?php echo $arrContent['Candidate']['candidate_first_name'] . " " . $arrContent['Candidate']['candidate_last_name']; ?></a>
                                        ...
                                        <tr id="str<?php echo $arrContent['Candidate']['candidate_id']; ?>" class="hide-str">
                                            <td>
                                            </td>
                                            <td colspan="3">
...
<script type="text/javascript">
 ...
 function fnExportCandidateOrder()
 {
	...
	$.ajax({ 
			type: "POST",
			url: appBaseU+"vendororders/candidateexport/"+strStartDate+"/"+strEndDate,
			data: '',
			cache: false,
			dataType:"json",
