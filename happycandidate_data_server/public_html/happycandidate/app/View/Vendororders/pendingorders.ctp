              ...
              <!--  <p>Sed cursus id libero molestie ullamcorper. Nullam cursus mauris in enim interdum varius. Integer ex risus, dignissim nec placerat ac, mattis vitae augue.</p>-->
                ...
                <div class="tab-row-container">
                    <div class="tab-filters">
                        ...
                        <a class="active" href="<?php echo $strAdminPendingUrl; ?>">Pending </a> |
                                    ...
                                    if (is_array($arrProductList) && (count($arrProductList) > 0)) {
                                        ...
                                        foreach ($arrProductList as $arrContent) {
                                            ...
                                            <tr id="product_list_<?php echo $arrContent['Resourceorderdetail']['order_detail_id']; ?>">
                                                <td>
                                                    <?php echo $intContentCount; ?></a>
                                                </td>
                                                <td>
                                                    <div class="user-title">
                                                        <a class="username-clickable" id="task1" href="#str<?php echo $arrContent['Resourceorderdetail']['order_detail_id']; ?>"><?php echo $arrContent['mainorder']['Resourceorder']['order_name']; ?></a>
                                                    </div>
                                                </td>

                                                <td><?php echo stripslashes($arrContent['Resourceorderdetail']['product_name']); ?></td>
