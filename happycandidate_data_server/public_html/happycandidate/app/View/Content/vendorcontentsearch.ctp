	            ...
	            <div class="container-fluid">
	                <div class="row">
	                    <div class="tab-header">
							...
							<?php
			$strProductSearchUrl = Router::url(array('controller'=>'content','action'=>'vendorcontent'),true);
		?>
				...
				foreach($arrProductList as $arrContent)
				{
					...
					?>
										<tr id="product_list_<?php echo $arrContent['content']['content_id'];?>">
											...
											<td>
											<?php
								//echo "--".$arrContent['content']['created_date'];
								...
								else
								{
									...
									{
										if($arrContent['content']['content_for_user'] == "5")
										{
											echo "Vendors";
										}
									}
