							  	...
							  	<div class="panel-heading admin-content">
									<table id="product_list">
										<tr>
											...
											<th class="selected" style="width:30%!important;">Title<span></span></th>
											<th style="width:15%!important;">Content User</th>
											<th style="width:15%!important;">Content Type</th>
				...
				foreach($arrProductList as $arrContent)
				{
					...
					?>
							...
							<td style="width:15%!important;">
											...
											<td style="width:15%!important;" id="status_<?php echo $arrContent['content']['content_id'];?>"><?php echo ucfirst($arrContent['content']['content_status'])=="Published"?"Active":"Inactive"; ?></td>
											<td style="width:15%!important;"><?php echo date($productdateformat,strtotime($arrContent['content']['created_date'])) ?></td>
										</tr>
		...
		?>
							 	...
							 	<div class="panel-footer admin-content">
							 		...
							 		<table>
										<tr>
											<th style="width:10%!important;">ID #</th>
											<th style="width:30%!important;" class="selected">Title<span></span></th>
											<th style="width:15%!important;">Content User</th>
											<th style="width:15%!important;">Content Type</th>
											<th style="width:15%!important;">Status</th>
											<th style="width:15%!important;">Date Created</th>
