...
?>
<?php
echo $this->element('passwordnotification_confirmation_subvendor');
?>
                                        ...
                                        <tr id="product_list_<?php echo $arrContent['Vendors']['vendor_id']; ?>">
                                            ...
                                            <td>
                                                <div class="user-title">
                                                    <a href="#str<?php echo $arrContent['Vendors']['vendor_id']; ?>" id="task1" class="username-clickable"><?php echo isset($arrContent['Vendors']['vendor_first_name']) ? stripslashes($arrContent['Vendors']['vendor_first_name'] . " " . $arrContent['Vendors']['vendor_last_name']) : '-'; ?></a>
                                                </div>
                                            </td>
                                        ...
                                        <tr id="str<?php echo $arrContent['Vendors']['vendor_id']; ?>" class="hide-str">
                                            ...
                                            if ($arrLoggedUser['parent_vendor']) {
                                                ...
                                                <div id="task1-options" class="user-options">
                                                    ...
                                                    <a onclick="fnConfirmInquiryDelete('<?php echo $arrContent['Vendors']['vendor_id'];?>')" href="javascript:void(0);" class="link-warning">Delete</a>
