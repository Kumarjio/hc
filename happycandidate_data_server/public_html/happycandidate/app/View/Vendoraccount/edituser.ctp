                            ...
                            <div class="form-container vendor-edit-profile">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-9">
                                        <input type="text" name="vfname" id="vfname" class="validate[required]" value="<?php echo $arrProductList[0]['Vendors']['vendor_first_name']; ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-9">
                                        <input type="text" name="vlname" id="vfname" class="validate[required]" value="<?php echo $arrProductList[0]['Vendors']['vendor_last_name']; ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-9">
                                        <input type="text" name="vemail" id="vemail" class="validate[required,custom[email]]" value="<?php echo $arrProductList[0]['Vendors']['vendor_email']; ?>" />
                                        <input type="hidden" name="vid" id="vid" value="<?php echo $arrProductList[0]['Vendors']['vendor_id']; ?>" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-xs-12 col-sm-12 col-md-3">
                                        <label class="control-label" for="phone">Phone: <span class="form-required">*</span></label>
                                    </div>
                                    <div class="col-xs-12 col-sm-12 col-md-9">
                                        <input type="text" name="vphone" id="vphone" class="validate[required]" value="<?php echo $arrProductList[0]['Vendors']['vendor_phone']; ?>" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-xs-12 col-sm-12 col-md-3">
                                        <label class="control-label" for="password">Password: <span class="form-required">*</span></label>
                                    </div>
                                    <div class="col-xs-12 col-sm-12 col-md-9">
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12 col-sm-12 col-md-3">
                                        <label class="control-label" for="confirm-password">Confirm Password: <span class="form-required">*</span></label>
                                    </div>
                                    <div class="col-xs-12 col-sm-12 col-md-9">
...
<script type="text/javascript">
	...
	//$("#UserEdituserForm").validationEngine();
	...
	{
		var strResult = $("#UserEdituserForm").validationEngine('validate');
		return strResult;
	}
</script>
<style>
