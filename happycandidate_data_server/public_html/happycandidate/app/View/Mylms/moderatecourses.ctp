     ...
     <div class="page-content-wrapper">
		...
		?>
			...
			if(is_array($arrProductList) && (count($arrProductList)>0))
			{
				...
				{
					$intContentCount++;
					$strProductEditUrl = Router::url(array('controller'=>'resource','action'=>'edit',$arrContent['Resources']['productd_id']),true);
					$strPreviewUrl = Router::url(array('controller'=>'resource','action'=>'preview',"5",$arrContent['Resources']['productd_id']),true);
					$strProductManageUrl = Router::url(array('controller'=>'mylms','action'=>'manage',$arrContent['Resources']['productd_id']),true);
					?>
										<tr id="product_list_<?php echo $arrContent['Resources']['productd_id'];?>">
						  <td><?php echo $intContentCount; ?></td>
						
											<td>
												<div class="user-title">
													<a href="#str<?php echo $arrContent['Resources']['productd_id'];?>" id="task1" class="username-clickable"><?php echo stripslashes($arrContent['Resources']['product_name']); ?></a>
												</div>
											</td>
											
											<td><?php echo $arrContent['Resources']['product_type'];
							?></td>
											<td><?php echo date($productdateformat,strtotime($arrContent['Resources']['product_creation_date'])) ?></td>
											
										</tr>
										<tr id="str<?php echo $arrContent['Resources']['productd_id'];?>" class="hide-str">
											<td></td>
											<td colspan="3">
