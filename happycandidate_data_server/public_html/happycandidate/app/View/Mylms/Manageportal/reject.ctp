		...
		<div class="row">
			...
			<div class="tab-row-container resourcetab">
				<div class="panel panel-default hidden-xs hidden-sm">
					...
					<input type="hidden" id="contentName" value="reject" />
						<table>
							<?php
									...
									foreach($arrProductList as $arrContent)
									{
										...
										?>
											<tr id="product_list_<?php echo $arrContent['career_portal']['career_portal_id'];?>">
											  ...
											  <td id="status_<?php echo $arrContent['career_portal']['career_portal_id'];?>" data-attr="<?php echo $arrContent['career_portal']['career_portal_approved'];?>"><?php echo ucfirst($arrContent['career_portal']['career_portal_approved'])=="1"?"Approved":"Rejected"; ?></td>
