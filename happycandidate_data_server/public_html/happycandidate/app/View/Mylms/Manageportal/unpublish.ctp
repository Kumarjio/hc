									...
									foreach($arrProductList as $arrContent)
									{
										...
										?>
											<tr id="product_list_<?php echo $arrContent['career_portal']['career_portal_id'];?>">
											  ...
											  <td id="status_<?php echo $arrContent['career_portal']['career_portal_id'];?>" data-attr="<?php echo $arrContent['career_portal']['career_portal_published'];?>"><?php echo ucfirst($arrContent['career_portal']['career_portal_published'])=="1"?"Published":"UnPublished"; ?></td>

											  <td><?php echo date($productdateformat,strtotime($arrContent['career_portal']['career_portal_created_datetime'])) ?></td>
											  <td><a href="<?php echo $strPreviewUrl ?>" class="link-primary">Preview</a>&nbsp;|&nbsp;<a href="javascript:void(0);" id="content_status_<?php echo $arrContent['career_portal']['career_portal_id'];?>" onclick="return fnChangePortalStatus(this);" class="link-primary">Change Status</a> 
											  </td>
											</tr>
