							...
							<div class="panel panel-default hidden-xs hidden-sm">
							  	<div class="panel-heading admin-content">
									<table id="product_list">
										<tr>
											<th>ID #</th>
											<th class="selected">Template Name<span></span></th>
											<th>From Email </th>
											<th>From Name </th>
											<th>Email Subject</th>
				...
				foreach($arrEmailTemplateList as $arrEmailList)
				{
					...
					?>
										<tr id="product_list_<?php echo $arrEmailList['Email']['id'];?>">
											...
											<td><?php echo $arrEmailList['Email']['from_name']; ?></td>
											<td><?php echo $arrEmailList['Email']['from_email']; ?></td>
											<td><?php echo $arrEmailList['Email']['email_subject']; ?></td>
											
											<td><?php echo $arrEmailList['Email']['created_date']; ?></td>
