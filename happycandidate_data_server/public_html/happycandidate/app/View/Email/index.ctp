    ...
    <div class="container-fluid">
        <div class="row">
            <div class="tab-header">
                ...
                <?php $contentadd = Router::url(array('controller' => 'email', 'action' => 'add'), true); ?>
            ...
            <div class="tab-row-container">
                <div id="strTemplatemessage"></div>
                <div class="panel panel-default hidden-xs hidden-sm">
                    <div class="panel-heading admin-content">
                        <table id="product_list">
                            <tr>
                                <th style="width:6%!important;">ID #</th>
                                <th class="selected" style="width:15%!important;">Template Name<span></span></th>
                                <th style="width:15%!important;">From Name</th>
                                <th style="width:27%!important;">From Email</th>
                                <th style="width:23%!important;">Email Subject</th>
                                <th style="width:12%!important;">Date Created</th>
                    ...
                    <div class="panel-body admin-content">
                        <table>
                            <?php
                            if (is_array($arrEmailTemplateList) && (count($arrEmailTemplateList) > 0)) {
                                $intContentCount = 0;
                                foreach ($arrEmailTemplateList as $arrEmailList) {
                                    $intContentCount++;
                                    $strProductEditUrl = Router::url(array('controller' => 'email', 'action' => 'add', $arrEmailList['Email']['id']), true);
                                    $strPreviewUrl = Router::url(array('controller' => 'Email', 'action' => 'preview', "5", $arrEmailList['Email']['id']), true);
                                    ?>
                                    <tr id="product_list_<?php echo $arrEmailList['Email']['id']; ?>">
                                        <td style="width:6%!important;">
                                            <?php echo $intContentCount; ?>
                                        </td>
                                        <td style="width:15%!important;">
                                            <div class="user-title">
                                                <a href="#str<?php echo $arrEmailList['Email']['id']; ?>" id="task1" class="username-clickable"><?php echo stripslashes($arrEmailList['Email']['template_name']); ?></a>
                                            </div>
                                        </td>
                                        <td style="width:15%!important;"><?php echo $arrEmailList['Email']['from_name']; ?></td>
                                        <td style="width:27%!important;"><?php echo $arrEmailList['Email']['from_email']; ?></td>
                                        <td style="width:23%!important;"><?php echo $arrEmailList['Email']['email_subject']; ?></td>
                                        <td style="width:12%!important;"><?php echo date($productdateformat, strtotime($arrEmailList['Email']['created_date'])); ?></td>

                                    </tr>
                                    <tr id="str<?php echo $arrEmailList['Email']['id']; ?>" class="hide-str">
                                        <td></td>
                                        <td colspan="5">
                                            <div id="task1-options" class="user-options">
                                                <a href="<?php echo $strProductEditUrl; ?>" class="link-primary">Edit</a> |
                                                <a href="#" id="template_del_<?php echo $arrEmailList['Email']['id']; ?>" onClick="return fnEmailTemplate(this);" class="link-warning">Delete</a>
                                            </div>
                                        </td>
                                    </tr>
