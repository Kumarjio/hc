			...
			<div class="col-md-12 resume-builder-8-awards flex-fix">
			 ...
			 --><div class="content-step">
				...
				<?php
					...
					if(count($candidateawards)>0)
					{
					   foreach($candidateawards as $arrEdu)
					   {
						   ...
						   $description = $arrEdu['Candidate_Awards']['amount'];
						   $date = $arrEdu['Candidate_Awards']['date'];
						   $intFrCnt++;
						   ?>
					...
					<div id="awardd"></div>
						...
						<div class="form-group">
							<button class="btn btn-default btn-responsive btn-lg"  type="button" onClick="return getMyPublications('<?php echo $intPortalId?>','<?php echo $resumeid;?>');">&lt;&nbsp;Prev</button>
				...
				<div class="aside-actions-container">
					<h2>Definition</h2>
					<p>
						Provide the date, (in descending order) name of the award or honor, institution and  monetary amount.
					</p>
