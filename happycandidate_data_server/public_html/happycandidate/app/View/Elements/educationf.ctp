...
<li class="resume-builder-step" onclick="return getContactInfof('<?php echo $intPortalId?>','<?php echo $resumeid;?>');">
										...
										<li class="resume-builder-step-current" onclick="return getMyEducationF('<?php echo $intPortalId?>','<?php echo $resumeid;?>');">
			 ...
			 --><div class="content-step">
					...
					?>
						...
						<div class="form-group">
							<button class="btn btn-default btn-responsive btn-lg" type="button" onclick="return getCoreCompentsf('<?php echo $intPortalId?>','<?php echo $resumeid;?>');">&lt;&nbsp;Prev</button>
				...
				<div class="aside-actions-container">
					<h2>Definition</h2>
					<p>
						The Summary of Skills replaces the Past Experience section of a chronological CV or resume.  Under this section, organize the top 3-5 broad skill sets that specifically relate to your job targets or job descriptions that you can back up with specific accomplishments or experiences.   You can identify the skills most needed for specific jobs and professions by reviewing sample job postings.  Examples of skills most often used include communication, leadership and project management.
					</p>
					<p>
