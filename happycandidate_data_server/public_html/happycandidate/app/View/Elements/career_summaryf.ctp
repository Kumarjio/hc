		...
		<div class="row bg-lightest-grey">
			...
			<div class="col-md-12 resume-builder-3-career-summary flex-fix">
				...
				<li class="resume-builder-step" onclick="return getContactInfof('<?php echo $intPortalId?>','<?php echo $resumeid;?>');">
										...
										<li class="resume-builder-step-current" onclick="return getCareerSumf('<?php echo $intPortalId?>','<?php echo $resumeid;?>');">
			 ...
			 --><div class="content-step">
					...
					<form name="frmcarsumm" id="frmcarsumm" method="post">
						...
						<div class="form-group">
							...
							<button class="btn btn-default btn-responsive btn-lg" type="button" onclick="return getContactInfof('<?php echo $intPortalId?>','<?php echo $resumeid;?>');" >&lt;&nbsp;Prev</button>
