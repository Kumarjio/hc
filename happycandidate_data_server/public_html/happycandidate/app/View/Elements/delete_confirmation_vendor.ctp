<!-- Modal -->
<div id="confirm_delete_vendor" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<script type="text/javascript">
	$('#delete_confirm').click(function () {
		...
		if(deleteFor != "")
		{
			$("#confirm_delete_vendor").modal('hide');
			deleteVendor(deleteFor);
		}
		return false;
	});
