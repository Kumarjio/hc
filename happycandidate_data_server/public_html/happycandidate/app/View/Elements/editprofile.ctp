...
$('#photoCover').html($(this).val());
									...
									<label class="control-label col-xs-12 col-sm-12 col-md-3">City / Town: </label>
										...
										<div class="form-group">
											<label class="control-label col-xs-12 col-sm-12 col-md-3">Job Title </label>
											 <input type="text" placeholder="" name="txt_job_title" value="<?php echo $profileDetail['CandidateProfile']['job_title'];?>" class="col-xs-12 col-sm-12 col-md-9 validate[required]">
										</div>
