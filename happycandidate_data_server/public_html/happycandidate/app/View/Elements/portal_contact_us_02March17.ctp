...
?>
	<div class="wrapper">
		<div>
			...
			<h2>Contact Us</h2>
			<?php 
				echo $strContactUsUrl = Router::url(array('controller'=>'portal','action'=>'contactus',$portal_id),true);
			...
			<ul class="panel-2 margin-top-5">
				...
				<textarea style="color: black;" class="basiceditor"  required rows="5" cols="55" name="message" id="message"></textarea>
