							...
							<?php
								...
								if($arrPortalWidget['PW']['career_portal_id'] == $arrPortalDetail[0]['Portal']['career_portal_id'] && $arrPortalWidget['PW']['career_portal_page_id'] == $arrPortalPageDetail[0]['PortalPages']['career_portal_page_id'])
								{
									...
									?>
										...
										<span id="enable_widget_<?php echo $intWidgetId; ?>" style="cursor:pointer;display:none;color:blue;text-decoration:underline;" onclick="fnEnableWidget('<?php echo $intWidgetId; ?>','<?php echo $intPortalId; ?>','<?php echo $intPageId; ?>','<?php echo $strWidgetName; ?>','page')">Add</span> &nbsp;
									<?php
								}
								else
								{
									?>
										...
										<span id="enable_widget_<?php echo $intWidgetId; ?>" style="cursor:pointer;color:blue;text-decoration:underline;" onclick="fnEnableWidget('<?php echo $intWidgetId; ?>','<?php echo $intPortalId; ?>','<?php echo $intPageId; ?>','<?php echo $strWidgetName; ?>','page')">Add</span> &nbsp;
									<?php
								}
							?>
						</td>
