...
<script type="text/javascript">
	$('#theme_confirm_yes').click(function () {
		...
		if(arrElementId[1] != "")
		{
			...
			$("#selectedtheme1 a").text('Select Now');
			$("#selectedtheme2 a").text('Select Now');
			$("#selectedtheme3 a").text('Select Now');
			$("#selectedtheme4 a").text('Select Now');
			$("#selectedtheme11 a").text('Select Now');
			$("#selectedtheme12 a").text('Select Now');
			$("#selectedtheme13 a").text('Select Now');
			$("#selectedtheme14 a").text('Select Now');
			$("#selectedtheme21 a").text('Select Now');
			$("#selectedtheme22 a").text('Select Now');
			$("#selectedtheme23 a").text('Select Now');
			
			$("#" + arrElementId[0] + " " + "a").text("Selected");
