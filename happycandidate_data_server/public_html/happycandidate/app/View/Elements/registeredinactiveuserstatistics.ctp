<div class="users  container-layout">
	...
	<tr>
			...
			<th class="tb_col_head" width="15%">Date Registered </th>
			<th class="tb_col_head" width="15%">Date Inactivated </th>
	</tr>
	<?php
		/*print("<pre>");
			...
			foreach($arrPortalUserList as $arrPortalUser)
			{
				...
				?>
					<tr <?php echo $class;?>>
						...
						<td class="tb_col_data"><?php echo date('Y-m-d',strtotime($arrPortalUser['PortalUser']['candidate_inactivation_date'])); ?></td>
		...
		else
		{
			?>
				...
				<tr>
					<td colspan='7'><span style="margin-left:20%;">No Inactive Job Seekers`</span></td>
				</tr>
			<?php
		}
	?>
