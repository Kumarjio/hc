<div class="users container-layout">
	...
	<tr>
			...
			<th class="tb_col_head" width="13%">Portal Name</th>
			<th class="tb_col_head" width="12%">Phone Number</th>
			<th class="tb_col_head" width="20%">Portal Creation Date</th>
	...
	<?php
		...
		else
		{
			?>
				...
				<tr>
					<td colspan='7' align="center"><span>No Active Owners</span></td>
				</tr>
			<?php
		}
	?>
