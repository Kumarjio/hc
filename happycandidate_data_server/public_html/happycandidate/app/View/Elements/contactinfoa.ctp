			 ...
			 --><div class="content-step">
					...
					<h1>Contact Information</h1>
						...
						if(count($contactinfo)>0)
						{
							...
							{
								$strUserCountry = $country = $contactinfo['Candidate_Cv']['country'];
							}
							else
							{
								$strUserCountry = $country = $arrCandidateDetail[0]['CandidateProfile']['country'];
							}
					...
					<form name="contactform" id="contactform" method="post" >
						...
						<div class="form-group">
							...
							<input class="resume-builder-input" type="text" name="state" id="state" value="<?php echo $state;?>" placeholder="">
						</div>
...
$(document).ready(function () {
	$('#country').val('<?php echo $strUserCountry;?>');
});
</script>
<?php
