<?php 
//echo '<pre>fff';print_r($arrProductContent[0]['Content']['content']);die;
$strCancelUrl = Router::url(array('controller' => 'resourcecourse','index'), true);?>
...
<script type="text/javascript">
    ...
    function fnSubmitContent(isToBePublished)
    {
        ...
        } else
        {
            ...
            var pageurl = "<?php echo Router::url('/', true) . "resourcecourse/add/"; ?>";
            var pagetype = "POST";
            var pageoptions = {
...
<form id="contentform" name="contentform" action="" method="post" role="form">
    ...
    <div class="form-group">
        <div class="col-md-12 nomargin"><strong>Regular Cost:</strong></div>
        <div class="col-md-9">
            <?php
            if (isset($arrProductContent[0]['Resources']['product_cost'])) {
                ?>
                <input value="<?php echo stripslashes($arrProductContent[0]['Resources']['product_cost']); ?>" id="service_cost" name="service_cost" type="text" class="form-control validate[required]" placeholder="Enter your regular cost here">
                <?php
            } else {
                ?>
                <input value="" id="service_cost" name="service_cost" type="text" class="form-control validate[required]" placeholder="Enter your regular cost here">
                <?php
            }
            ?>
        </div>
    ...
    <div class="form-group">
        <div class="col-md-12 nomargin"><strong>Discount Cost:</strong></div>
        <div class="col-md-9">
            <?php
            if (isset($arrProductContent[0]['Resources']['discount_cost'])) {
                ?>
                <input value="<?php echo stripslashes($arrProductContent[0]['Resources']['discount_cost']); ?>" id="discount_cost" name="discount_cost" type="text" class="form-control validate[required]" placeholder="Enter your discount cost here">
                <?php
            } else {
                ?>
                <input id="discount_cost" name="discount_cost" type="text" class="form-control validate[required]" placeholder="Enter your discount cost here">
                <?php
            }
            ?>
        </div>
    ...
    <div class="form-group">
        <div class="col-md-12 nomargin"><strong>Course Type:</strong></div>
        <div class="col-md-9">
            <select name="txtcoursetype" name="txtcoursetype">
                <?php
                $product_type = $arrProductContent[0]['Resources']['product_type']
                ?>
                <option value="Course" <?php
                if ($product_type == "Course") {
                    echo "selected='selected'";
                }
                ?> >Interview Best Course</option>
                <option value="SkillSoftcourse" <?php
                if ($product_type == "SkillSoftcourse") {
                    echo "selected='selected'";
                }
                ?> >Skill Soft Course</option>
            </select>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <div class="col-md-12 nomargin"><strong>Title Alias:</strong></div>
        <div class="col-md-9">
            <?php
...
<!--            <div class="tinymce-tabs nopadding nomargin">
            ...
            <?php
            if (isset($arrProductContent[0]['Content']['content_intro_text'])) {
                ?>
                <textarea class="form-control" id="intro_content" name="intro_content1" rows="5"><?php echo stripslashes($arrProductContent[0]['Content']['content_intro_text']); ?></textarea>
                <?php
            } else {
                ?>
                <textarea class="form-control" id="intro_content" name="intro_content1" rows="5"></textarea>
                <?php
            }
            ?>
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-12">
            <div class="col-md-12 nopadding nomargin" style="float:left;width:100%;clear:none;">	
                <div class="col-md-5 nopadding nomargin" style="float:left;">
...
<!--                <div class="nopadding nomargin"  style="float:right;clear:none;">
            ...
            <div class="col-md-12 nopadding">
                <?php
                if (isset($arrProductContent[0]['Content']['content'])) {
                    ?>
                    <textarea class="form-control" id="main_content" name="main_content1" rows="5"><?php echo ($arrProductContent[0]['Content']['content']); ?></textarea>
                    <?php
                } else {
                    ?>
                    <textarea class="form-control" id="main_content" name="main_content1" rows="5"></textarea>
                    <?php
                }
                ?>
            </div>
    ...
    <div class="row">
        <div class="col-md-9">
            <input name="add" id="add" type="submit" value="Save as Draft"/>&nbsp;
            <input name="add_publish" id="add_publish" type="submit" value="Save & Publish"/>&nbsp;
            <!--<button name="add" id="add" class="btn btn-lg btn-primary" type="button"><a href="<?php //echo $strPreviewUrl; ?>" target="_blank">Preview</a></button>&nbsp;-->
            <input name="cancel" id="cancel" type="reset" value="Cancel" onclick="window.history.back();"/>
            <!--<input name="cancel" id="cancel" type="cancel" onclick="window.location = '<?php echo $strCancelUrl; //$this->Session->read('strCancelUrl');  ?>'" value="Cancel"/>-->
        </div>
    </div>
</form>
</div>
