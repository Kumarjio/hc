<form id="contentfileform" name="contentfileform" action="" method="post" role="form">
	<div class="row nopadding nomargin">
		...
		<div class="col-md-3" style="width:30%;">
			<input type="hidden" name="frmvendor" id="frmvendor" value="1">
			<input data-toggle="modal" data-target="#mediaModal" name="add_media_main_content" id="add_media" class="content_media_button_order_update" type="button" value="Add Files" style="width:auto;"></input>
		</div>
	</div>
	<!--<div class="row">
