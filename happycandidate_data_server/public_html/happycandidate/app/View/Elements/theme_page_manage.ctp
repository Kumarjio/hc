<div id="dialog-page-form" title="Edit Home Page" style="display:none;">
	...
	<form id="pageform">
		<?php //print_r($arrPortalPageDetail);
	...
	$( "#dialog-page-form" ).dialog({
			...
			buttons: {
				"Save": function() {
					...
					{
						$('#pageloader').show();
						var pageurl = "<?php echo Router::url('/', true)."employers/updatepagedata/".$arrPortalDetail['0']['Portal']['career_portal_id']?>";
						var pagetype = "POST";
						var pageoptions = { 
				...
				"Remove This Content": function() {
					...
					{
						$('#pageloader').show();
						var pageurl = "<?php echo Router::url('/', true)."employers/removeportalpage/".$arrPortalDetail['0']['Portal']['career_portal_id']?>";
						var pagetype = "POST";
						var pageoptions = { 
							beforeSubmit:  function(formData, jqForm, options) {
								formData.push({name:'page_data', value:strPageContent});
