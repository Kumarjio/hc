...
<div style="float:left;width:100%;<?php echo $strFontFamily; ?>" class="container">
	...
	<!--<div id="contactsection"  style="float:left;width:100%;margin-bottom:10px;">
		<div id="contactsectionhead" style="float:left;width:100%;">
			<h4 style="margin-bottom:0px;text-transform:uppercase;">Contact Information</h4>
		</div>
		<div id="separator" style="float:left;width:100%;">
			<hr style="margin-top:2px;"/>
		</div>
		<div id="contactsectionbody" style="float:left;width:100%;">
			<div id="contactbody" style="float:left;width:50%;">
				<div style="float:left;width:30%;">
					First Name:
				</div>
				<div style="float:left;width:70%;">
					<?php 
						if($arrCvDetail[0]['Candidate_Cv']['firstName'])
						{
							echo $arrCvDetail[0]['Candidate_Cv']['firstName']; 
						}
						else
						{
							echo "-";
				...
				<div style="float:left;width:70%;">
					<?php 
						if($arrCvDetail[0]['Candidate_Cv']['middle_initial'])
						{
							echo $arrCvDetail[0]['Candidate_Cv']['middle_initial']; 
						}
						else
						{
							echo "-";
				...
				<div style="float:left;width:70%;">
					<?php 
						if($arrCvDetail[0]['Candidate_Cv']['lastName'])
						{
							echo $arrCvDetail[0]['Candidate_Cv']['lastName']; 
						}
						else
						{
							echo "-";
				...
				<div style="float:left;width:70%;">
					<?php 
						if($arrCvDetail[0]['Candidate_Cv']['streetAddress'])
						{
							echo $arrCvDetail[0]['Candidate_Cv']['streetAddress']; 
						}
						else
						{
							echo "-";
				...
				<div style="float:left;width:70%;">
					<?php 
						if($arrCvDetail[0]['Candidate_Cv']['city'])
						{
							echo $arrCvDetail[0]['Candidate_Cv']['city']; 
						}
						else
						{
							echo "-";
				...
				<div style="float:left;width:70%;">
					<?php 
						if($arrCvDetail[0]['Candidate_Cv']['country'])
						{
							echo $arrCvDetail[0]['Candidate_Cv']['country']; 
						}
						else
						{
							echo "-";
				...
				<div style="float:left;width:70%;">
					<?php 
						if($arrCvDetail[0]['Candidate_Cv']['homePhone'])
						{
							echo $arrCvDetail[0]['Candidate_Cv']['homePhone']; 
						}
						else
						{
							echo "-";
				...
				<div style="float:left;width:70%;">
					<?php 
						if($arrCvDetail[0]['Candidate_Cv']['cellPhone'])
						{
							echo $arrCvDetail[0]['Candidate_Cv']['cellPhone']; 
						}
						else
						{
							echo "-";
				...
				<div style="float:left;width:70%;">
					<?php 
						if($arrCvDetail[0]['Candidate_Cv']['email_address'])
						{
							echo $arrCvDetail[0]['Candidate_Cv']['email_address']; 
						}
						else
						{
							echo "-";
