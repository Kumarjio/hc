        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="tab-row-container">
                    ...
                    <button name="add_payment" id="add_payment" type="button" class="btn btn-default btn-md export-btn" onclick="fnGetComissionPayout()" >Add Payment</button>
                </div>
                <div class="tab-row-container">
...
<script type="text/javascript">
    ...
    function fnpayoutsExport()
    {
        ...
        $.ajax({
            type: "GET",
            url: appBaseU + "managepayouts/cpaComissionExport",
    ...
    function fnGetComissionPayout() {
        ...
        var datastrj = "OwnerId=" + Owners + "&strFromDate=" + strFromDate + "&strToDate=" + strToDate + "&payoutCost=" + payoutCost;
        $.ajax({
            type: "POST",
            url: strPayoutUrl,
            data: datastrj,
