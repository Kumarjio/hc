...
<div class="page-content-wrapper">
	            <div class="container-fluid">
	                <div class="row">
	                    <div class="tab-header">
							<h3>Sub Steps List</h3>
							
								<?php
			$strVendoraddUrl = Router::url(array('controller'=>'jsprocesssubsteps','action'=>'add'),true);
		?>
	...
	<div class="tab-row-container ">
							...
							<?php
			$strProductSearchUrl = Router::url(array('controller'=>'jsprocesssubsteps','action'=>'index'),true);
		?>
			...
			if(is_array($arrProductList) && (count($arrProductList)>0))
			{
				...
				foreach($arrProductList as $arrContent)
				{
					...
					$intContentCount++;
					$strProductEditUrl = Router::url(array('controller'=>'jsprocesssubsteps','action'=>'edit',$arrContent['Categories']['content_category_id']),true);
					?>
						<tr id="product_list_<?php echo $arrContent['Categories']['content_category_id'];?>">
						  <td><?php echo $arrContent['Categories']['job_search_order'];?></td>
...
<div class="sub-header index row"><h2>Substeps List</h2></div>
<div class="row index" style="width:100%;float:left;">
	<div class="col-md-12" style="width:100%;float:left;">
		...
		?>
		<form id="productlistfilterform" name="productlistfilterform" action="<?php echo $strProductSearchUrl;?>" method="post" role="form">
			<div class="col-md-3 nopadding" style="float:left;width:20%;clear:none;"><input type="hidden" class="form-control" name="filter_on" id="filter_on" value="1" /><input type="text" class="form-control validate[required]" name="product_keyword" id="product_keyword" placeholder="Substeps title" /></div>
