		...
		?>
			...
			if(is_array($jobs) && (count($jobs)>0))
			{
				...
				//print_r($jobdetail);
					...
					$strPreviewUrl = Router::url(array('controller'=>'Joblisting','action'=>'preview',"5",$jobdetail['Joblisting']['id']),true);
					?>
										...
										<tr id="str<?php echo $jobdetail['Joblisting']['id'];?>" class="hide-str">
											...
											<td colspan="5">
												<div id="task1-options" class="user-options">
													...
													<a href="<?php echo $strPreviewUrl; ?>" class="link-primary">Inactive</a> |
													<a href="javascript:void(0);" id="content_delete_<?php echo $jobdetail['Joblisting']['id'];?>" onclick="return fnDeleteContent(this);" class="link-warning">Delete</a>|
