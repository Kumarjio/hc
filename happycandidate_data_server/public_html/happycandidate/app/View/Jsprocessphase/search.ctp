	            ...
	            <div class="container-fluid">
	                <div class="row">
	                    <div class="tab-header">
							<h3>Phases List</h3>
								<?php
			$strVendoraddUrl = Router::url(array('controller'=>'jsprocessphase','action'=>'add'),true);
		?>
	...
	<div class="tab-row-container ">
		...
		?>
			...
			if(is_array($arrProductList) && (count($arrProductList)>0))
			{
				...
				{
					$intContentCount++;
					$strProductEditUrl = Router::url(array('controller'=>'jsprocessphase','action'=>'edit',$arrContent['Categories']['content_category_id']),true);
					?>
...
<div class="sub-header index row"><h2>Phases List</h2></div>
<div class="index row" style="width:100%;float:left;">
	<div class="col-md-12" style="width:100%;float:left;">
		...
		?>
		<form id="productlistfilterform" name="productlistfilterform" action="<?php echo $strProductSearchUrl;?>" method="post" role="form">
			<div class="col-md-3 nopadding" style="float:left;width:20%;clear:none;"><input type="hidden" class="form-control" name="filter_on" id="filter_on" value="1" /><input type="text" value="<?php echo $strKeywordSearch;?>" class="form-control validate[required]" name="product_keyword" id="product_keyword" placeholder="Category title" /></div>
