							  	...
							  	<div class="panel-heading vendor-orders">
									<table>
										<tr>
											...
											<th style="width:15%!important;">Order ID</th>
											<th class="selected" style="width:15%!important;">Title<span></span></th>
											<!--<th>Status</th>-->
											<th style="width:10%!important;">Payment Status</th>
											<th style="width:10%!important;">Vendor Type</th>
											<th style="width:9%!important;">Owner</th>
											<th style="width:9%!important;">Cost</th>
											<th style="width:9%!important;">Vendor Cost</th>
											<th style="width:9%!important;">Owner Cost</th>
											<th style="width:9%!important;">HC Cost</th>
										</tr>
									</table>
							  	</div>
			...
			if(is_array($arrProductList) && (count($arrProductList)>0))
			{
				...
				foreach($arrProductList as $arrContent)
				{
					...
					<tr >
											...
											<td style="width:15%!important;"><?php echo stripslashes($arrContent['service']['Resources']['product_name']); ?></td>
											<td style="width:10%!important;" id="order_status_payment_<?php echo $arrContent['Resourceorderdetail']['order_detail_id'];?>"><?php 
											...
											<?php
												...
												{
													?>
														<td style="width:10%!important;"><?php echo ucfirst($arrContent['Resourceorderdetail']['vendor_type']); ?></td>
														<td style="width:10%!important;"><?php 
												...
												else
												{
													?>
														<td style="width:10%!important;"><?php echo ucfirst($arrContent['Resourceorderdetail']['vendor_type']); ?></td>
														<td style="width:9%!important;"><?php 
															if(is_array($arrSubVendorUser) && (count($arrSubVendorUser)>0))
															{
																echo $arrSubVendorUser['Vendors']['vendor_first_name']." ".$arrSubVendorUser['Vendors']['vendor_last_name'];
															}
											...
											?>
											<td style="width:9%!important;"><?php echo "$ ".$arrContent['Resourceorderdetail']['product_unit_cost']?></td>
											<?php
												if($arrContent['Resourceorderdetail']['refund_status'])
												{
													?>
														<td style="width:9%!important;"><?php echo "$ 0.00";?></td>
													<?php
												}
												else
												{
													?>
														<td style="width:9%!important;"><?php echo "$ ".$arrContent['Resourceorderdetail']['vendor_cost']?></td>
													<?php
												}
											?>
											<?php
												...
												{
													?>
														<td style="width:9%!important;"><?php echo "$ ".$arrContent['Resourceorderdetail']['portal_owner_cost']?></td>
													<?php
												}
											?>
											<?php
												...
												{
													?>
														<td style="width:9%!important;"><?php echo "$ ".$arrContent['Resourceorderdetail']['hc_profit_cost']?></td>
													<?php
												}
											?>
