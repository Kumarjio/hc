                    ...
                    <div class="panel-heading admin-content">
                        <table>
                            <tr>
                                ...
                                <th class="selected" style="width:30%!important;">Image<span></span></th>
                                <th style="width:20%!important;">Preview</th>
                                <th style="width:20%!important;">Service </th>
                                <th style="width:20%!important;">Added On </th>
                            </tr>
                        </table>
                    </div>
                            ...
                            if (is_array($arrProductList) && (count($arrProductList) > 0)) {
                                ...
                                foreach ($arrProductList as $arrContent) {
                                    ...
                                    <tr id="product_list_<?php echo $arrContent['product_images']['product_images_id']; ?>">
                                        ...
                                        <td style="width:20%!important;"><img src="<?php echo Router::url('/', true) . "productfiles/thumbnail/" . $arrContent['product_images']['product_image']; ?>"></td>
                                        <td style="width:20%!important;"><?php echo $arrContent['product_images']['service']; ?></td>
                                        <td style="width:20%!important;"><?php echo date($productdateformat, strtotime($arrContent['product_images']['product_image_creation_date'])) ?></td>
