...
function deleteJob(intProductId)
{
	...
	$.ajax({ 
			...
			success: function(data)
			{
				...
				{
					//alert(data.content)
					$('#alertcvMessage').html('<div class="alert alert-success"><img alt="image description" src="http://www.rothrsolutions.com/happycandidate/images/icon-alert-success.png"><a aria-label="close" data-dismiss="alert" class="close" href="#">×</a>'+data.message+'</div>');
					$('#alertcvMessage').show();
