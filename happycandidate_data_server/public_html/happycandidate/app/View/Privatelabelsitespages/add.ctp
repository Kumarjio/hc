<?php
	echo $this->Html->script('portalpages_add');
...
<div class="users index">
	...
	<tr>
			...
			<td>
				<?php
					echo $this->Form->input('portal_page_title',array('style'=>'width:50%;font-size:90%;','type'=>'text','class'=>'validate[required]'));
				?>
			</td>
	</tr>
	<tr>
			<td><span id="madatsym" class="madatsym">*</span>Page Content:</td>
			<td>
				<?php 
					echo $this->Form->input('portal_page_content',array('rows' => '5', 'cols' => '5','style'=>'width:50%;font-size:90%;','class'=>'validate[required]'));
				?>
				<?php echo $this->Form->hidden('portal_id',array('value'=>$portal_id));?>
			</td>
	</tr>
	<tr>
