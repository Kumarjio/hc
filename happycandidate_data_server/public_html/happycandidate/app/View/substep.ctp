...
?>
					...
					if(is_array($arrStepsNavigationDetails) && (count($arrStepsNavigationDetails)>0))
					{
						if(isset($arrStepsNavigationDetails['nextnavigation']))
						{
							...
							?>
								...
								<h4 class="osr14 text-middle-dark-grey"><a style="float:left;margin-right:10px;"  name="nex_button_<?php echo $intCatDetailId; ?>" id="nex_button_<?php echo $intCatDetailId; ?>" href="javascript:void(0);" onclick="return fnGetSubstepDetail(<?php echo $intPortalId;?>,<?php echo $arrStepsNavigationDetails['nextnavigation']['substep'];?>,<?php echo $arrStepsNavigationDetails['nextnavigation']['Steps'];?>,<?php echo $arrStepsNavigationDetails['nextnavigation']['Phase'];?>)" class="btn btn-primary">Next</a></h4>
							<?php
						}
		...
		{?>
						...
						?>
							...
							<p class="wizard-price">Regular Price <s>$<?php echo $product_cost;?></s></p>
...
<div id="addtocart" class="modal fade" role="dialog"></div>
<div id="addtocartqqq" class="modal fade" role="dialog">
							...
							if(is_array($arrStepsNavigationDetails) && (count($arrStepsNavigationDetails)>0))
					{
						if(isset($arrStepsNavigationDetails['nextnavigation']))
						{
							...
							?>
								...
								<h4 class="osr14 text-middle-dark-grey"><button  name="nex_button_<?php echo $intCatDetailId; ?>" id="nex_button_<?php echo $intCatDetailId; ?>" href="javascript:void(0);" onclick="return fnGetSubstepDetail(<?php echo $intPortalId;?>,<?php echo $arrStepsNavigationDetails['nextnavigation']['substep'];?>,<?php echo $arrStepsNavigationDetails['nextnavigation']['Steps'];?>,<?php echo $arrStepsNavigationDetails['nextnavigation']['Phase'];?>)" class="btn btn-default">Next Step</button></h4>
							<?php
						}
