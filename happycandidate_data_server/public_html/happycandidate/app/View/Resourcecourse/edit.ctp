	...
	<div class="container-fluid">
		<div class="row">
			...
			<ul class="nav nav-pills tab-list">
				<li class="active"><a href="#js-vendor-panel" data-toggle="pill" id="js-vendor-panel">Services Panel</a></li>
                                <li><a id="cat-tab" data-toggle="pill" href="#tab_cat">Resources Categories</a></li>
			</ul>
			<div style="padding-top: 20px;" class="tab-content">
				<div class="tab-pane fade in active" id="tab-vendor-panel">
					<?php 
						echo $this->element("servicescourse");
					?>
				</div>
			</div>
