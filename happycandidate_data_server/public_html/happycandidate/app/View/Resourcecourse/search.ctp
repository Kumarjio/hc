<?php
$columnName = $_SESSION['searchcolumn'];
$sort = $_SESSION['searchsort'];
?>
...
<?php echo $this->element('delete_confirmation');?>
                    ...
                    <table id="product_list" class="tablesorter panel-heading admin-content">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="action" style="width:10%!important;">&nbsp;</th>
                            </tr>
                        </thead>
                        <!--</div>-->
                        <tbody class="panel-body admin-content" id="sortRecords">
                                <!--<table id="product_list" class="table tablesorter">-->
                            <?php
                            // echo '<pre>';print_r($arrProductList);die;
...
<script type="text/javascript">
 $(document).ready(function ()
    ...
    var sort = $("#sort").val();
    $.ajax({
     url:strBaseUrl+"resourcecourse/search/<?php echo $strKeywordSearch;?>",
     type:'post',
