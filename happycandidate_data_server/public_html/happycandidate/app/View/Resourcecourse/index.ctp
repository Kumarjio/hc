...
<?php
echo $this->element('course_delete_confirmation');
?>
<div class="page-content-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="tab-header">
                <h1>Publish Courses</h1>
                <div style="margin-top:5px;" id="product_notification"></div>
            </div>
            <div class="tab-row-container ">			
                <div class="tab-search">
                    <?php
                    $strProductSearchUrl = Router::url(array('controller' => 'resourcecourse', 'action' => 'index'), true);
                    ?>
                ...
                <div class="tab-row-container resourcetab">
                    <div class="panel panel-default hidden-xs hidden-sm">
                        <table id="product_list" class="tablesorter panel-heading admin-content">
                            ...
                            <input type="hidden" id="column_name" value="product_name">
                            <thead>
                                <tr>
...
//    if (localStorage.getItem("publish") == null || localStorage.getItem("publish") == 'false') {
//        localStorage.setItem('publish','1');
//    }
    var sort = $("#sort").val();
    $.ajax({
     url:strBaseUrl+"resourcecourse/index",
     type:'post',
     data:{columnName:columnName,sort:sort},
     dataType: 'json',
     success: function(response){
        
//        if (localStorage.getItem("publish") == null || localStorage.getItem("publish") == '1') {
//            localStorage.setItem('publish', '2');
//            closeAndRefresh(columnName);
//        }
    ...
    function closeAndRefresh(columnName){
