<?php
$columnName = $_SESSION['moderatedsearchcolumn'];
$sort = $_SESSION['moderatedsearchsort'];
?>
...
<script type="text/javascript">
    ...
    var sort = $("#sort").val();
    $.ajax({
     url:strBaseUrl+"resourcecourse/moderatedsearch/<?php echo $strKeywordSearch;?>",
     type:'post',
