<div class="users index">
	<h2>Candidate's Scheduled Interviewd Jobs</h2>
	<div style="height:50px;">
		&nbsp;
	</div>
<?php
	if(is_array($arrScheduledInterviewJobs) && (count($arrScheduledInterviewJobs)>0))
	{
		...
		<?php
			$intForI = 0;
			$class = null;
			foreach($arrScheduledInterviewJobs as $arrJobDetail)
			{
				if ($intForI++ % 2 == 0) 
				{
