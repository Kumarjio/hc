<div class="page-content-wrapper employers-type" style="min-height:500px;">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1>New Vendors Added</h1>
                <div class="tab-row-container">
                    <p>Listed are all New Vendors Added in your Career Portal</p>
                    ...
                    <button name="export" id="export" type="button" class="btn btn-default btn-md export-btn" onclick="fnExportVendors()" >Export</button>
                </div>
                <div class="tab-row-container">
                        ...
                        <div class="panel-heading emp-dashboard-jobs emp-dashboard-pages">
                            <table>
                                <tr>
                                    ...
                                    <th>Vendor Type</th>
                                    <th>Vendor Phone</th>
                                    <th style="height: 30px !important;">Added Date</th>
                                </tr>
                            </table>
                        </div>
                        <?php if (is_array($arrNewVendors) && (count($arrNewVendors) > 0)) { ?>
                            <div class="panel-body emp-dashboard-jobs emp-dashboard-pages">
                                <table>
                                    ...
                                    if (is_array($arrNewVendors) && (count($arrNewVendors) > 0)) {
                                        $intForI = 0;
                                        $class = null;
                                        foreach ($arrNewVendors as $arrVendors) {
                                            if ($intForI++ % 2 == 0) {
                                                $class = ' class="altrow"';
                                            }
                                            ?>
                                            <tr <?php echo $class; ?>>
                                                ...
                                                <td><?php echo stripslashes($arrVendors['vendors']['vendor_email']); ?></td>
                                                <td><?php echo stripslashes($arrVendors['vendors']['vendor_first_name']); ?></td>
                                                <td><?php echo stripslashes($arrVendors['vendors']['vendor_last_name']); ?></td>
                                                <td><?php echo stripslashes($arrVendors['vendors']['vendor_type']); ?></td>
                                                <td><?php echo stripslashes($arrVendors['vendors']['vendor_phone']); ?></td>
                                                <td style="height: 30px !important;"><?php echo date($productdateformat, strtotime($arrVendors['sub_vendor_order_service']['inserted_date_time'])); ?></td>
                                            </tr>
                                            <?php
                                            $count++;
                                        }
                            ...
                            <table>
                                ...
                                <tr>
                                    <td colspan='6'><span style="margin-left:20%;">No New Vendors Added</span></td>
                                </tr>
                            </table>
                            <?php
                        }
...
<script type="text/javascript">
    ...
    function fnExportVendors()
    {
        ...
        $.ajax({
            type: "GET",
            url: appBaseU + "adminanalytics/vendorsExport",
