                                    ...
                                    if (is_array($arrPayoutDetails) && (count($arrPayoutDetails) > 0)) {
                                        ...
                                        foreach ($arrPayoutDetails as $payouts) {
                                            ...
                                            <tr <?php echo $class; ?>>
                                                ...
                                                <?php if ($payoutType == 'vendor') { ?>
                                                    <td style="width:25%!important;height:40px!important;"><?php echo isset($vendorName) ? ucfirst($vendorName) : '-'; ?></td>
                                                <?php } else { ?>
                                                    <td style="width:25%!important;height:40px!important;"><?php echo isset($ownerName) ? ucfirst($ownerName) : '-'; ?></td>
                                                <?php } ?>
...
<script type="text/javascript">
    ...
    function fnPaidPayoutsExport()
    {
        ...
        $.ajax({
            type: "GET",
            url: appBaseU + "adminanalytics/paidPayoutsExport",
            data: 'StartDate=' + strStartDate + "&EndDate=" + strEndDate + "&vendorId=" + vendorId + "&ownerId=" + ownerId + "&payoutType=" + payoutType + "&vendorName=" + vendorName + "&ownerName=" + ownerName + "&portalId=" + portalId,
            cache: false,
            dataType: "json",
