<div class="page-content-wrapper employers-type" style="min-height:500px;">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1>Job seeker(s) <?php echo $productTypes;?> Refunded Order(s)</h1>
                <div class="tab-row-container">
                    <p>Listed are all job seeker(s) <?php echo $productTypes;?> Refunded order(s) in your Career Portal</p>
                    ...
                    <div class="panel panel-default hidden-xs hidden-sm">
                        ...
                        if (is_array($arrJobSeekerPurchaseOrderList) && (count($arrJobSeekerPurchaseOrderList) > 0)) { ?>
                                    ...
                                    if (is_array($arrJobSeekerPurchaseOrderList) && (count($arrJobSeekerPurchaseOrderList) > 0)) {
                                        ...
                                        foreach ($arrJobSeekerPurchaseOrderList as $arrJobSeekerPurchaseOrder) {
                                            ...
                                            <tr <?php echo $class; ?>>
                                                ...
                                                <td>$<?php echo $arrJobSeekerPurchaseOrder['0']['total']; ?></td>
                            ...
                            <table>
                                ...
                                <tr>
                                    <td colspan='5'><span style="margin-left:20%;">No job seeker(s) <?php echo $productTypes;?> Refunded order(s)</span></td>
                                </tr>
                            </table>
                            <?php
                        }
...
<script type="text/javascript">
	...
	var PortalId = '<?php echo $portalId;?>';
        ...
        var strDatePeriod = '<?php echo $datePeriod;?>';
		
	$('.cms-bgloader-mask').show();//show loader mask
	$('.cms-bgloader').show(); //show loading image
	$.ajax({ 
            type: "GET",
            url: appBaseU+"adminanalytics/orderRefundedExport",
            data: 'StartDate='+strStartDate+"&EndDate="+strEndDate+"&portalId="+PortalId+"&productType="+strProductType+"&datePeriod="+strDatePeriod,
            cache: false,
            dataType:"json",
