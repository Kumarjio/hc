<div class="page-content-wrapper employers-type" style="min-height:500px;">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1>Last Login Job Seeker(s)</h1>
                <div class="tab-row-container">
                    <p>Listed are all last login in your Career Portal</p>
                    ...
                    <div class="panel panel-default hidden-xs hidden-sm">
                        ...
                        <?php if (is_array($arrPortalUserList) && (count($arrPortalUserList) > 0)) { ?>
                                    ...
                                    if (is_array($arrPortalUserList) && (count($arrPortalUserList) > 0)) {
                                        ...
                                        foreach ($arrPortalUserList as $arrPortalUser) {
                                            ...
                                            <tr <?php echo $class; ?>>
                                                ...
                                                <td><?php echo date($productdateformat, strtotime($arrPortalUser['PortalUser']['last_login_date'])); ?></td>
                                            </tr>
                                            <?php
                                            $count++;
                                        }
                            ...
                            <table>
                                ...
                                <tr>
                                    <td colspan='6'><span style="margin-left:20%;">No last login Job Seekers</span></td>
                                </tr>
                            </table>
                            <?php
                        }
...
<script type="text/javascript">
    ...
    function fnExportUsers()
    {
        ...
        $.ajax({
            type: "GET",
            url: appBaseU + "adminanalytics/userExport",
