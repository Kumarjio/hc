<div class="page-content-wrapper employers-type" style="min-height:500px;">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1>Inactive Portal Owner(s)</h1>
                <div class="tab-row-container">
                    <p>Listed are all inactive portal owner(s) in your Career Portal</p>
                    ...
                    <div class="panel panel-default hidden-xs hidden-sm">
                        ...
                        <?php if (is_array($arrPortalOwnerList) && (count($arrPortalOwnerList) > 0)) { ?>
                            ...
                            <table>
                                ...
                                <tr>
                                    <td colspan='6'><span style="margin-left:40%;">No inactive portal owner(s)</span></td>
                                </tr>
                            </table>
                            <?php
                        }
