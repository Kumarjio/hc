<div class="page-content-wrapper employers-type" style="min-height:500px;">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1>Total Unique Visitors Registered Career Portal</h1>
                <div class="tab-row-container">
                    <p>Listed are all total unique visitors registered in your career portal</p>
                    ...
                    <div class="panel panel-default hidden-xs hidden-sm">
                        ...
                        <?php if (is_array($arrTotalVisitors) && (count($arrTotalVisitors) > 0)) { ?>
                            ...
                            <table>
                                ...
                                <tr>
                                    <td colspan='6'><span style="margin-left:20%;">No total unique visitors registered in your career portal</span></td>
                                </tr>
                            </table>
                            <?php
                        }
...
<script type="text/javascript">
    ...
    function fnExportVisitors()
    {
        ...
        $.ajax({
            type: "GET",
            url: appBaseU + "adminanalytics/visitorsExport",
