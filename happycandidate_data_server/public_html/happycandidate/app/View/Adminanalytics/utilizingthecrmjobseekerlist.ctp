<div class="page-content-wrapper employers-type" style="min-height:500px;">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1>Utilizing The CRM Job Seeker(s)</h1>
                <div class="tab-row-container">
                    <p>Listed are all Utilizing The CRM Job Seeker(s) in your Career Portal</p>
                    ...
                    <button name="export" id="export" type="button" class="btn btn-default btn-md export-btn" onclick="fnExportUtilizingTheCRMUsers()" >Export</button>
                </div>
                <div class="tab-row-container">
...
<script type="text/javascript">
    ...
    function fnExportUtilizingTheCRMUsers()
    {
