<div class="page-content-wrapper employers-type" style="min-height:500px;">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1>Register Portal Owner(s)</h1>
                <div class="tab-row-container">
                    <p>Listed are all register portal owner(s) in your Career Portal</p>
                ...
                <div class="tab-row-container">
                    ...
                    <div class="panel panel-default hidden-xs hidden-sm">
                        ...
                        <?php
//                        echo '<pre>';print_r($arrPortalOwnerList);
                        ...
                        <table>
                            ...
                            <tr>
                                <td colspan='6'><span style="margin-left:20%;">No register portal owner(s)</span></td>
                            </tr>
                        </table>
                            <?php
                        }
