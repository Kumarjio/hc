<div class="page-content-wrapper employers-type" style="min-height:500px;">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1>Owners Jobs Posted Clicking Job Seeker(s)</h1>
                <div class="tab-row-container">
                    <p>Listed are all Owners Jobs Posted Clicking Job Seeker(s) in your Career Portal</p>
                    ...
                    <button name="export" id="export" type="button" class="btn btn-default btn-md export-btn" onclick="fnExportJobViewsUsers()" >Export</button>
                </div>
                <div class="tab-row-container">
                    ...
                    <div class="panel panel-default hidden-xs hidden-sm">
                        ...
                        <?php if (is_array($arrJobsViews) && (count($arrJobsViews) > 0)) { ?>
                            <div class="panel-body emp-dashboard-jobs emp-dashboard-pages">
                                <table>
                                    ...
                                    if (is_array($arrJobsViews) && (count($arrJobsViews) > 0)) {
                                        $intForI = 0;
                                        $class = null;
                                        foreach ($arrJobsViews as $arrPortalUser) {
                                            if ($intForI++ % 2 == 0) {
                                                $class = ' class="altrow"';
                                            }
                                            ?>
                                            <tr <?php echo $class; ?>>
                                                ...
                                                <td><?php echo $arrPortalUser['career_portal_candidate']['candidate_email']; ?></td>
                                                <td><div class="user-title"><?php echo $arrPortalUser['career_portal_candidate']['candidate_first_name']; ?></div></td>
                                                <td><?php echo $arrPortalUser['career_portal_candidate']['candidate_last_name']; ?></td>
                                                <td><?php echo $arrPortalUser['PortalName']['pname']; ?></td>
                                                <td><?php echo date($productdateformat, strtotime($arrPortalUser['jobberland_graph_statistics']['action_date'])); ?></td>
                                            </tr>
                                            <?php
                                            $count++;
                                        }
                            ...
                            <table>
                                ...
                                <tr>
                                    <td colspan='6'><span style="margin-left:20%;">No Utilizing The CRM Job Seeker(s)</span></td>
                                </tr>
                            </table>
                            <?php
                        }
...
<script type="text/javascript">
    ...
    function fnExportJobViewsUsers()
    {
        ...
        $.ajax({
            type: "GET",
            url: appBaseU + "adminanalytics/jobCRMExport",
