<div class="page-content-wrapper employers-type" style="min-height:500px;">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1>Job Boards Using Job Seeker(s)</h1>
                <div class="tab-row-container">
                    <p>Listed are all Job Boards Using Job Seeker(s) in your Career Portal</p>
                    ...
                    <button name="export" id="export" type="button" class="btn btn-default btn-md export-btn" onclick="fnExportJobBoardUsingUsers()" >Export</button>
                </div>
                <div class="tab-row-container">
                    ...
                    <div class="panel panel-default hidden-xs hidden-sm">
                        ...
                        <?php if (is_array($arrJobsViews) && (count($arrJobsViews) > 0)) { ?>
                            ...
                            <table>
                                ...
                                <tr>
                                    <td colspan='6'><span style="margin-left:20%;">No Job Boards Using Job Seeker(s)</span></td>
                                </tr>
                            </table>
                            <?php
                        }
...
<script type="text/javascript">
    ...
    function fnExportJobBoardUsingUsers()
    {
