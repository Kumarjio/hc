        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="tab-row-container">
                    <p>Listed are all 15 step process completed job seeker(s) in your Career Portal</p>
                    ...
                    <div class="panel panel-default hidden-xs hidden-sm">
                        ...
                        <?php } else {
                            ...
                            <table>
                                ...
                                <tr>
                                    <td colspan='8'><span style="margin-left:20%;">No 15 step process completed job seeker(s)</span></td>
                                </tr>
                            </table>
                        <?php } ?>
                </div>
...
<script type="text/javascript">
    ...
    function fn15ProcessCompletedExport()
    {
        ...
        $.ajax({
            type: "GET",
            url: appBaseU + "adminanalytics/registered15ProcessCompletedExport",
