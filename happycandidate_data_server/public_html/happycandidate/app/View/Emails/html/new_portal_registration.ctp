                              ...
                              <td style="text-align:left;margin:0;padding:20px;border:none;white-space:normal;line-height:normal;background-color:rgb(255,255,255);font-family:georgia;font-size:13pt;" valign="top">
                                ...
                                <div>
								  ...
								  <p> Hi There <?php echo $first_name;?>,</p>
								   ...
								   <p > Thanks for registering with <?php echo $portal_name;?>.</p>
Please click <a href="<?php echo $this->Html->url(array('controller'=>'candidates','action'=>'confirmation',$portal_id,base64_encode($user_id)),true); ?>">Here</a>
<p><b>Thanks</b></p>
                                  </div>
                                </div>
                              </td>
