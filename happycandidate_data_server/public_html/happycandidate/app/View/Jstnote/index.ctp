<?php
	$strAddUrl = Router::url(array('controller'=>'jstnote','action'=>'add',$intPortalId),true);
?>
<div class="wrapper">
	<div id="jop_search" class="jop_search">
		...
		<div style="float:left;width:100%;">
			...
			<a style="float:right;margin-right:10px;" href="<?php echo $strAddUrl; ?>" name="add_contact_but" id="add_contact_but" class="button_class">Add Notes</a>
		</div>
		<?php
			echo $this->element('filter_notes');
		?>
					...
					?>
						<div style="width:95%;border:none;" class="line_up_td" id="contact">
							...
							<div style="width:20%;" class="line_up_title">
								<a title="<?php echo $arrAppointment['JstAppointments']['jstappointments_contact_fname']; ?>" href="javascript:void(0);">Note Title</a>
							</div>
				...
				else
				{
					?>
						<div id="contact_message" style="float:left;width:100%;">
							<strong>You don't have any Notes added in your list, Please add one</strong>
						</div>
					<?php
				}
			?>
