                                        ...
                                        <form id="offersform" name="offersform" action="" method="post" role="form">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-xs-12 col-sm-12 col-md-4" for="email">Offer Id : </label>
                                                    <input id="pf_offer_id" name="pf_offer_id" type="text" class="form-control validate[required] col-xs-12 col-sm-12 col-md-8" placeholder="Enter offer Id here"> 
                                            </div>
                                            
                                            <div class="form-group">
                                                <label class="control-label col-xs-12 col-sm-12 col-md-4" for="email">Offer Name : </label>
                                                    <input id="offer_name" name="offer_name" type="text" class="form-control validate[required] col-xs-12 col-sm-12 col-md-8" placeholder="Enter offer name here"> 
                                            </div>
                                            
                                            <div class="form-group">
                                                <label class="control-label col-xs-12 col-sm-12 col-md-4" for="email">Offer Url : </label>
                                                    <input id="offer_url" name="offer_url" type="text" class="form-control validate[required] col-xs-12 col-sm-12 col-md-8" placeholder="Enter offer url here"> 
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-xs-12 col-sm-12 col-md-4" for="email">Portal Owner Revenue Share(%): </label>
                                                    <input id="portal_cost" name="portal_cost" type="text" class="form-control validate[required] col-xs-12 col-sm-12 col-md-8" placeholder="Enter portal owner share here"> 
                                            </div>
                                            
                                            <div class="form-group">
                                                <label class="control-label col-xs-12 col-sm-12 col-md-4" for="email">Offer Description : </label>
                                                <textarea id="intro_content" name="intro_content" type="text" class="form-control validate[required] col-xs-12 col-sm-12 col-md-8" placeholder="Enter offer description here"></textarea> 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-8 page-content-wrapper-buttons">
                                                    <button  class="btn btn-primary" name="add_offer" id="add_offer" type="button">Save Changes</button>
...
<script type="text/javascript">
    ...
    $('#add_offer').click(function () {
        ...
        } else
        {
            ...
            var pageurl = "<?php echo Router::url('/', true) . "managecpaoffers/addAction"; ?>";
            var pagetype = "POST";
            var pageoptions = {
