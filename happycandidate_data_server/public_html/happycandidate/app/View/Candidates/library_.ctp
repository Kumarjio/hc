	<div class="container-fluid bg-lightest-grey">
		...
		<div class="row">
			...
			<div class="col-md-10 bg-lightest-grey">
				...
				<?php //echo '<pre>';print_r($arrLibCatDetail);exit();
			if(isset($arrLibCatDetail))
			{
				if(is_array($arrLibCatDetail) && (count($arrLibCatDetail)>0))
				{
					...
					<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
						<div class="library-item item-<?php echo strtolower(str_replace(' ','-',$arrLibCatDetailVal['Categories']['content_category_name'])); ?>"></div>
