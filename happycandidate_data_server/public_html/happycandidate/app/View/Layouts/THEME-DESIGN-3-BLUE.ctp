...
<html lang="en">
    ...
    <head>
        ...
        <style>
            ...
            .blue-theme .navbar-default .navbar-nav > .active-tab > a {
                color: #4dcaff !important;
            }
            
            .blue-theme .navbar-custom .navbar-nav li a:hover {
                color: #fff !important;
            }
            
            .blue-theme .navbar-custom .navbar-nav .active-tab a:hover {
                color: #4dcaff !important;
            }
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        if (is_array($arrPortalMenuDetail) && (count($arrPortalMenuDetail) > 0)) {
                            ...
                            $strHomeEditorLink = Router::url(array('controller' => 'employers', 'action' => 'theme_selection', '?' => array('theme_name' => 'THEME-DESIGN-3', 'theme_color' => 'GREEN', 'portal_id' => $arrPortalDetail['0']['Portal']['career_portal_id'])));
                            ?>
                            <?php
        ...
        <section id="video-area">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <h1 class="text-algn">WELCOME TO THE CAREER PORTAL OF <?php echo $arrPortalDetail[0]['Portal']['career_portal_name']; ?></h1>
                    ...
                    <div class="row">                
                        <div class="footer-col col-md-12">
                            <ul class="list-inline text-center ftr-brdr">
                                ...
                                <li>  <div style="clear:both;color:black;" class="copyright"  onmouseover="fnApplyEditorHoverCss(this);fnShowEditCopyright();" onmouseout="fnRemoveEditorHoverCss(this);fnHideEditCopyright();">
                                        ...
                                        <?php } ?>
                                        <span style="cursor: pointer;display: none;font-size: 15px;font-weight: bold;left: 12px;position: relative;top: 0px;" id="copyrightsedit" onclick="fnShowCopyrightEditSection()">Manage <i class="fa fa-edit"></i></span>
                                    </div></li>
                            </ul>
                        </div>                     
                    </div>
