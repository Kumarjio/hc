...
<head>
	...
	<?php
		...
		echo $this->Html->script('jquery/jqueryui/development-bundle/ui/jquery.ui.menu');	
		echo $this->Html->script('jquery/jqueryui/development-bundle/ui/jquery.ui.autocomplete');
			...
			<ul id="menu">
					...
					if(isset($notificationDetail))
					{
						if(is_array($notificationDetail) && (count($notificationDetail)>0))
						{
							...
							?>
								<li id="noti_Container"><?php echo $this->Html->link("My Inbox",'javascript:void(0);',array('target'=>"_blank")); ?>
								<?php
									if($notifyCount)
									{
										?>
				...
				?>
				<li><?php echo $this->Html->link("My Profile",'javascript:void(0);',$strMenuProfileSelectedText); ?>
					<ul class="sub-menu">
						<li><a href='javascript:void(0);'>My Details</a></li>
						<li><a href='javascript:void(0);'>Modify Search</a></li>
						<!--<?php
						...
						?>-->
						<li><a href='javascript:void(0);'>CV/Resume</a></li>
						<li><a href='javascript:void(0);'>Cover Letters</a></li>
						<?php
						...
						<li><a href='javascript:void(0);'>Thank You Letters</a></li>
					</ul>
				</li>
				<li><a href="javascript:void(0);">Job Search Tracker</a>
					<ul class="sub-menu">
						<li><a href="javascript:void(0);">Tracking Tool</a></li>
					</ul>
				</li>
				<li><?php echo $this->Html->link("My Settings",'javascript:void(0);',$strMenuSettingSelectedText); ?>
					<ul class="sub-menu">
						<!--<li><a href="<?php echo $strLoginDetailUrl; ?>">Change Password</a></li>-->
						<li><a href='javascript:void(0);'>Latest Job Listing Notifications</a></li>
						<!--<li><a href="<?php echo $strSettingLatestResourceUrl."#resn" ;?>">Latest Resource Notifications</a></li>
						<li><a href="'javascript:void(0);'>Career Advisor</a></li>-->
				...
				<li><?php echo $this->Html->link("My Orders",'javascript:void(0);'); ?></li>
				<!--<li><?php echo $this->Html->link("My Account",'javascript:void(0);'); ?>
					<ul class="sub-menu">
						<li><a href="<?php echo $strLoginDetailUrl; ?>">Change Password</a></li>
					</ul>
				</li>-->
				<li><?php echo $this->Html->link("Contact Us",'javascript:void(0);',$strMenuContactUsSelectedText); ?></li>
				<li>
					<?php 
						if(isset($_SESSION['olduser']) && $_SESSION['olduser']['user_type'] == "1")
						{
							...
							echo $this->Html->link("Switch Back To Admin",'javascript:void(0);'); 
						}
						else
						{
				...
				if($logged_in)
				{
					?>
						<ul id='menusection'>
							...
							<li><a href="javascript:void(0);" class="home-icon">Job Search Process</a></li>
