...
<!--                        <li>
                            <a class="top-menu-item dropdown-toggle" href="<?php echo $strResourceUrl; ?>">Resources </a>
                        </li>-->
...
<!--                        <li class="dropdown">
                            <a href="<?php echo $strResourceUrl; ?>" class="dropdown-toggle" data-toggle="dropdown">Resources <b class="caret"></b></a>-->
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu xs-border" style="margin-top: 5px;">
                                ...
                                <li>
                                    <a href="<?php echo $strProfileUrl; ?>" class="right-top-menu-item dropdown-item">My profile</a>
                                </li>
                                <li>
...
//exit();
                    ...
                    <div class="col-xs-12 col-sm-12  col-md-3 text-right layout-fix">
                        <div class="ads-container">
                            ...
                            foreach ($arrResourcesDetail as $arrResource) {
                                ...
                                $strDefaultServiceImage = Router::url('/', true) . "productfiles/no-resourses-image.jpg";
                                ...
                                <a href="<?php echo $strServiceDetailUrl; ?>">
                                    <?php if($arrImageArray[0]['ResourcesImages']['product_image_path'] !=''){ ?>
                                    ...
                                    <?php }else{?>
                                        <div class="job-search-action-button-container">
                                            <img src='<?php echo $strDefaultServiceImage;?>' alt='Service Image' title='Service Image'></img>
                                        </div>
                                    <?php } ?>
                                </a>
                                <?php
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 layout-fix">
                        ...
                        <!--Offer Section-->
                        <div class="container-fluid sidebar-main-menu-container" style="margin-top: 20px;"> 
                            <?php foreach ($arrOffers as $offers) { 
//                                echo '<pre>';print_r($offers['Cpaoffers']['pf_offer_id']);
                                $strOfferDetailUrl = $offers['Cpaoffers']['offer_url']."?s1=".$strPortalName."";
                                ?>
                            <a href="<?php echo $strOfferDetailUrl?>" target="_blank">
                                <div class="sidebar-menuitem-content">
                                    <img src="<?php echo Router::url('/', true); ?>offer-images/<?php echo $offers['Cpaoffers']['offer_image'];?>">
                                </div>
                                            ...
                                            <div class="container-fluid footer-wizard">
                                                <footer>
                                                    <div class="left-nav">
                                                        ...
                                                        <a href="<?php echo $strContactUsUrl; ?>">Contact Us</a>
                                                    </div>
                                                    <div class="right-nav">
