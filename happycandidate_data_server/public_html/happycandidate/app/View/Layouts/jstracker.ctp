...
<head>
	...
	<?php
		...
		echo $this->Html->css('hometheme/worksheet');
		...
		echo $this->Html->css('jqueryui/themes/base/jquery.ui.timepicker');
...
<?php
	...
	if($logged_in)
	{
		...
		$strContactUsLink = Router::url(array('controller'=>'portal','action'=>'page',$intPortalId,$intContactUsPageId),true);
		?>
		<?php
		...
		<div class="wrapper">
			...
			<?php
				if($logged_in)
				{
					...
					$strJobSearchTrackerContactsUrl = Router::url(array('controller'=>'jstcontacts','action'=>'index',$intPortalId),true);
					$strJobSearchTrackerAppointmentsUrl = Router::url(array('controller'=>'jstappointments','action'=>'index',$intPortalId),true);
					$strJobSearchTrackerTasksUrl = Router::url(array('controller'=>'jsttasks','action'=>'index',$intPortalId),true);
					$strJobSearchTrackerCalendarUrl = Router::url(array('controller'=>'jstappointments','action'=>'calendar',$intPortalId),true);
					$strJobSearchTrackerNotesUrl = Router::url(array('controller'=>'jstnote','action'=>'index',$intPortalId),true);
					
					?>
						<ul id='menusection'>
							<li><a href="<?php echo $strJobSearchTrackerContactsUrl ;?>" class="home-icon">Contacts</a></li>
							<li><a href="<?php echo $strJobSearchUrl; ?>" class="home-icon">Job Search Process</a></li>
							<li><a href="<?php echo $strJobSearchTrackerAppointmentsUrl; ?>" class="home-icon">Appointments</a></li>
							<li><a href="<?php echo $strJobSearchTrackerTasksUrl; ?>" class="home-icon">Tasks</a></li>
							<li><a href="<?php echo $strJobSearchTrackerCalendarUrl; ?>" class="home-icon">Calendar</a></li>
							<li><a href="<?php echo $strJobSearchTrackerNotesUrl;?>" class="home-icon">Notes</a></li>							
						</ul>
					<?php
				}
				else
...
<?php
	$strContactUrl = Router::url(array('controller'=>'jstcontacts',action=>'index',$intPortalId),true);
	$strJsProcessIndexUrl = Router::url(array('controller'=>'jsprocess',action=>'index',$intPortalId),true);
	$strJsAppointmentIndexUrl = Router::url(array('controller'=>'jstappointments',action=>'index',$intPortalId),true);
?>
<!--Start footer -->
<div id="footer">
	<div class="wrapper">
		<ul>
			<li>
				<?php
					...
					{
						?>
							<a href="<?php echo $strContactUrl; ?>">MY CONTACTS</a>
						<?php
					}
				?>
			</li>
		...
		<ul>
			<li>
				<?php
					...
					{
						?>
							<a href="<?php echo $strJsProcessIndexUrl; ?>">JOB SEARCH PROCESS</a>
						<?php
					}
				?>
			</li>
		...
		<ul>
			<li>
				<?php
					...
					{
						?>
							<a href="<?php echo $strJsAppointmentIndexUrl; ?>">APPOINTMENTS</a>
						<?php
					}
				?>
			</li>
