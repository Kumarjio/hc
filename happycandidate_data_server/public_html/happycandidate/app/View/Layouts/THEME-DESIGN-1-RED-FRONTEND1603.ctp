	...
	<?php echo $this->Form->create('PortalUser',array('inputDefaults'=>array('label' => false,'div' => false),'type'=>'file',"onsubmit"=>"return fnLogCandidateLogIn('".$strLoginUrl."','".$strLogoutUrl."')","id"=>"PortalUserLoginForm"));?>
		<div class="form-inner"> 				
			<?php 
				...
				<?php echo $this->Form->input('email',array('type'=>'text',"class"=>"validate[required] form-control","placeholder"=>"EMAIL ADDRESS"));
            ...
            <div class="container">
				...
				<?php } ?>
                    ...
                    <div class="footer-col col-md-4">
					   ...
					   <?php if($arrEmployerDetail["Employer"]["show_contact_number"] == '1') {
								echo "Phone - ".$arrEmployerDetail["Employer"]["employer_contact_number"]."<br><br>";
							} ?>
							
						<?php if($arrEmployerDetail["Employer"]["show_email"] == '1') {
