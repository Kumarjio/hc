            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
					...
					if(is_array($arrPortalMenuDetail) && (count($arrPortalMenuDetail)>0))
					{
						...
						$strHomeEditorLink = Router::url(array('controller'=>'employers','action'=>'theme_selection','?' => array('theme_name'=>'THEME-DESIGN-2','theme_color'=>'RED','portal_id'=>$arrPortalDetail['0']['Portal']['career_portal_id'])));?>
                    <?php
