            ...
            <div class="container">
                ...
                <div class="navbar-header page-scroll">
                    ...
                    <?php if (isset($arrPortalDetail['0']['Portal']['career_portal_logo'])) { ?>
                        <?php echo $this->Html->image('/userdata/portal/' . $arrPortalDetail['0']['Portal']['career_portal_logo'], array('id' => 'portal_header_logo', 'alt' => $arrPortalDetail['0']['Portal']['career_portal_name'], 'height' => '28', 'width' => '28')); ?>
                    <?php } else { ?>
...
<!--<form onsubmit="return fnLogCandidateLogIn(<?php echo $strLoginUrl; ?>,<?php echo $strLogoutUrl; ?>)" id="PortalUserLoginForm" enctype="multipart/form-data" method="post">
                <div class="form-inner"> 
                <div id="loginerror"></div>
                        <input type="text" class="validate[required] form-control" placeholder="EMAIL ADDRESS" id="PortalUserEmail" name="data[PortalUser][email]">
                        <input type="password" class="validate[required] form-control" placeholder="PASSWORD" id="PortalUserPassword" name="data[PortalUser][password]">
                        <input type="hidden" name="data[PortalUser][portal_id]" value="<?php echo $intPortalId; ?>" id="PortalUserPortalId">
                        
                        <button type="submit" onclick="return validateLogin();" class="btn btn-success btn-lg">Login</button>
...
//echo $this->Form->hidden('',array('id'=>'facebook_process_url', 'value'=>$strFURL));
                                ...
                                <div class="social-login"> 
                                    ...
                                    echo $this->Form->hidden('', array('id' => 'facebook_process_url', 'value' => $strFURL));
                                    ?>
                                    <a href="#" title="facebook" onClick="connectMe()" ><img src="<?php echo Router:: url('/', true); ?>themes/THEME-DESIGN-1/img/fb-login.png" alt="Facebook login"></a> 
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <div class="ddata">Proven step-by-step process to finding a job </div> 
                    </div>
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="ddata">Live training webinars – bring your questions; receive answers</div> 
                    </div>
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="ddata">Free resource to track your contacts and job search activities  </div>   
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <div class="ddata">Customized advice based on your Resume or CV through the eyes of an employer </div>     
                    </div>
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="ddata">Create a keyword rich Resume or CV</div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        ...
                        <!--                        <h3>WEEKLY CAREER ADVISOR</h3>
                                                <div class="ddata">Obtain customized feedback about your Resume or CV</div>-->
                        <h3>WEEKLY CAREER ADVISOR</h3>
                ...
                <div class="container">
                    <div class="row">
                        <div class="footer-col col-md-5">
                            ...
                            <?php if (isset($arrPortalDetail['0']['Portal']['career_portal_logo'])) { ?>
                                <?php echo $this->Html->image('/userdata/portal/' . $arrPortalDetail['0']['Portal']['career_portal_logo'], array('id' => 'portal_header_logo', 'alt' => $arrPortalDetail['0']['Portal']['career_portal_name'], 'height' => '28', 'width' => '28')); ?><br>
                            <?php } else { ?>
