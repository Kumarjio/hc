...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .purpel-theme .navbar-default .navbar-nav > .active-tab > a {
                color: #fff !important;
            }
            
            .active-tab{
                background: #9594da none repeat scroll 0 0;
                color: #fff !important;
            }
        </style>
        <style>
    ...
    <body id="page-top" class="index purpel-theme">
        <?php
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        if (is_array($arrPortalMenuDetail) && (count($arrPortalMenuDetail) > 0)) {
                            $strHomeEditorLink = Router::url(array('controller' => 'employers', 'action' => 'theme_selection', '?' => array('theme_name' => 'THEME-DESIGN-1', 'theme_color' => 'PURPLE', 'portal_id' => $arrPortalDetail['0']['Portal']['career_portal_id'])));
                            ?>
                            <?php
