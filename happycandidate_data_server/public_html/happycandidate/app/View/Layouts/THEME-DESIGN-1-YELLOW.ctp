...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .active-tab{
                background: #feb236 none repeat scroll 0 0;
                color: #fff !important;
            }
            .yellow-theme .navbar-custom .navbar-nav li a:active, .navbar-custom .navbar-nav li a:focus {
                color: #feb236;
            }
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        if (is_array($arrPortalMenuDetail) && (count($arrPortalMenuDetail) > 0)) {
                            ...
                            $strHomeEditorLink = Router::url(array('controller' => 'employers', 'action' => 'theme_selection', '?' => array('theme_name' => 'THEME-DESIGN-1', 'theme_color' => 'YELLOW', 'portal_id' => $arrPortalDetail['0']['Portal']['career_portal_id'])));
                            ?>
                            <?php
