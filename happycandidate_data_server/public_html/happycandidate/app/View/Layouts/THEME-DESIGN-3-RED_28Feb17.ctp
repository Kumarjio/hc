...
<head>
    ...
    <title>THEME-DESIGN-3-RED</title>
                ...
                <div class="col-lg-10 text-center">
                   ...
                   <span class="skills">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer ut imperdiet nibh. Mauris lorem enim, consectetur sit amet tincidunt et, porta quis tellus. Cras cursus dui eu ante scelerisque tempor.</span>
                    ...
                    <div class="form-inner"> <input type="text" class="form-control" placeholder="YOUR NAME" id="name" >
                                ...
                                <div class="social-login"> <a href="#"><img src="<?php echo Router:: url('/',true); ?>themes/THEME-DESIGN-3/img/fb-login.png" alt="Facebook login"></a> <a href="#"><img src="<?php echo Router:: url('/',true); ?>themes/THEME-DESIGN-3/img/twiiter-login.png" alt="Twitter login" ></a><div class="clear"></div></div>
                                </div>
                                                   </form>
...
<!-- Devices section -->
   <section id="devices">
    ...
    <div class="row">
     <div class="col-sm-6"> <h1>Lorem ipsum dolor sit amet consectetur.</h1>
