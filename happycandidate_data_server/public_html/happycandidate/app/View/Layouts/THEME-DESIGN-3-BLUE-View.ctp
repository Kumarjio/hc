                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        if (is_array($arrPortalMenuDetail) && (count($arrPortalMenuDetail) > 0)) {
                            ...
                            $strHomeEditorLink = Router::url(array('controller' => 'employers', 'action' => 'theme_selection', '?' => array('theme_name' => 'THEME-DESIGN-3', 'theme_color' => 'BLUE', 'portal_id' => $arrPortalDetail['0']['Portal']['career_portal_id'])));
                            ?>
                            <?php
                ...
                <div class="row">
                    <div class="col-lg-10 text-center">
                        <div class="intro-text">
                            ...
                            <span class="skills">This resource will help you find a job and advance your career. Learn insider secrets, successfully used by professional recruiters. </span>
                            <!--Form Starts-->			
...
//echo $this->Form->hidden('',array('id'=>'facebook_process_url', 'value'=>$strFURL));
        ...
        <section id="devices">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-6"  id="dummyTxt"> <h1>welcome to our company </h1>
                        <div id="widgets" onmouseover="fnApplyEditorHoverCss(this);fnShowWidgetSetter();" onmouseout="fnRemoveEditorHoverCss(this);
                                fnHideWidgetSetter();">
                            &nbsp;
