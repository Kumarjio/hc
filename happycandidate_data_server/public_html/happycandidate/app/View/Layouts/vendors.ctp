...
//        echo $this->Html->script('jquery/jqueryui/development-bundle/ui/jquery.ui.effect');
    ...
    if ($logged_in) {
        ...
        if ($logged_in) {
            ...
            $strContactUsUrl = Router::url(array('controller' => 'vendoraccount', 'action' => 'contactus'), true);
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu xs-border" style="margin-top: 5px;">
                                    ...
                                    <li>
                                        <a href="<?php echo $strCompanyEditUrl; ?>" class="right-top-menu-item dropdown-item">Company Details</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo $strPayoutEditUrl; ?>" class="right-top-menu-item dropdown-item">Payment Details</a>
                                    </li>
                                    <li>
        ...
        if ($logged_in) {
            ...
            $strAdminCandidatesUrl = Router::url(array('controller' => 'vendororders', 'action' => 'candidates'), true);
            ...
            $strManageVendorSaleUrl = Router::url(array('controller' => 'vendororders', 'action' => 'sales'), true);
            $strLibraryUrl = Router::url(array('controller' => 'vendoraccount', 'action' => 'library'), true);
            ?>
                    ...
                    <div class="admin-sidebar-wrapper">
                        <ul class="sidebar-nav nav-pills nav-stacked admin-menu">
                            ...
                            if ($current_user['parent_vendor']) {
                                ?>
                                <li  <?php if($last_segment == 'vendororders'){?> class="active leftnavi" <?php } ?>>
                                    <a href="<?php echo $strVendorOrdersUrl; ?>" title="My Orders">
                                ...
                                ?>
                                <li <?php if($last_segment == 'dashboard'){?> class="active" <?php } ?>>
                                    <a href="<?php echo $strdashboardUrl; ?>" title="Dashboard">
                                        <span class="glyphicon glyphicon-dashboard" aria-hidden="true"></span> 
                                        Dashboard
                                    </a>
                                </li>
                                <li <?php if($last_segment == 'library'){?> class="active" <?php } ?>>
                                    <a href="<?php echo $strLibraryUrl; ?>" title="Library">
                                        <span class="glyphicon glyphicon-book" aria-hidden="true"></span> 
                                        Library
                                    </a>
                                </li>
                                <li <?php if($last_segment == 'candidates'){?> class="active" <?php } ?>>
                                    <a href="<?php echo $strAdminCandidatesUrl; ?>" title="Candidates">
                                        <span class="glyphicon glyphicon-user" aria-hidden="true"></span> 
                                        Candidates
                                    </a>
                                </li>
                                <li <?php if($last_segment == 'index' || $last_segment == 'vendororders'){?> class="active" <?php } ?> >
                                    <a href="<?php echo $strVendorOrdersUrl; ?>" title="My Orders">
                                        <span class="glyphicon glyphicon-list" aria-hidden="true"></span> 
                                        My Orders
                                    </a>
                                </li>
                                <li <?php if($last_segment == 'adduser' && $second_segment == 'vendoraccount'){?> class="active" <?php } ?>>
                                    <a href="<?php echo $strAddVendorUserUrl; ?>" title="Add User">
                                        <span class="glyphicon glyphicon-user" aria-hidden="true"></span> 
                                        Add User
                                    </a>
                                </li>

                                <li <?php if($last_segment == 'mgusers' && $second_segment == 'vendoraccount'){?> class="active" <?php } ?>>
                                    <a href="<?php echo $strManageVendorUserUrl; ?>" title="Manage Users">
                                        <span class="glyphicon glyphicon-user" aria-hidden="true"></span> 
                                        Manage Users
                                    </a>
                                </li>
                                ...
                                if ($current_user['vendor_type'] == "Course") {
                                    ...
                                    $strCourseLMSLink = Router::url(array('controller' => 'vendorslms', 'action' => 'index'), true);
                                    ?>
                                    <li <?php if($last_segment == 'index' || $last_segment == 'vendorcourse'){?> class="active" <?php } ?>>
                                        <a href="<?php echo $strVendorcourseManageUrl; ?>" title="Manage Courses"><span class="glyphicon glyphicon-list" aria-hidden="true" ></span>Manage Courses</a>
                                        <div class="submenu">
                                            <ul>
                                                <li <?php if($last_segment == 'add' && $second_segment == 'vendorcourse'){?> class="active" <?php } ?>><a href="<?php echo $strVendorcourseAddManageUrl; ?>" title="Add Courses"><span aria-hidden="true" class="glyphicon glyphicon-transfer"></span>Add Courses</a></li>

                                                <li <?php if($last_segment == 'vendorcourse'){?> class="active" <?php } ?>><a href="<?php echo $strVendorcourseManageUrl; ?>" title="Published Course"><span aria-hidden="true" class="glyphicon glyphicon-transfer"></span>Published Course</a></li>
                                                <li <?php if($last_segment == 'drafted' && $second_segment == 'vendorcourse'){?> class="active" <?php } ?>><a href="<?php echo $strResourcecourseDraftAddUrl; ?>" title="Drafted Course"><span aria-hidden="true" class="glyphicon glyphicon-transfer"></span>Drafted Course</a></li>
                                                <li <?php if($last_segment == 'moderation' && $second_segment == 'vendorcourse'){?> class="active" <?php } ?>><a href="<?php echo $strResourcecourseModerationAddUrl; ?>" title="Course Moderation"><span aria-hidden="true" class="glyphicon glyphicon-transfer"></span>Course Moderation</a></li>
                                            </ul>
                                        </div>
                                    </li>
                                    <li <?php if($last_segment == 'vendorslms'){?> class="active" <?php } ?> style="display:inline;list-style-type: none;">
                                        <a href="<?php echo $strCourseLMSLink; ?>" title="MYLMS">
                                            <span class="glyphicon glyphicon-list" aria-hidden="true"></span>MYLMS</a>
                                    </li>
                                    <?php
                                } else {
                                    ?>
                            ...
                            ?>
                            <li <?php if($last_segment == 'sales' && $second_segment == 'vendororders'){?> class="active" <?php } ?>>
                                <a href="<?php echo $strManageVendorSaleUrl; ?>" title="Reporting"><span class="glyphicon glyphicon-signal" aria-hidden="true"></span>Reporting</a>
                            </li>	
                        </ul>
                        <div class="toggle-buttons-container">
                            <button class="navbar-toggle collapse in menu-toggle" data-toggle="collapse" title="Collapse Menu">
