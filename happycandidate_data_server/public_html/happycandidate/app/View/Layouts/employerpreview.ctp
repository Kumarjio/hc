...
<html>
    ...
    <body>
        ...
        <a href="../Privatelabelsites/library.ctp"></a>
        <?php
        ...
        <div id="top-nav">
            <div class="wrapper">
                <span class="nav-1 fright"><!--<a href="javascript:void()" class="selected">My Profile</a>	   |	<a href="javascript:void()">Conacts Us</a>-->	    <!--|	<a href="javascript:void()">Logout</a>--></span>
            </div>
        </div>
        <?php
        ...
        <div id="widgets">
            ...
            if (isset($arrPortalWidgets) && (is_array($arrPortalWidgets)) && (count($arrPortalWidgets) > 0)) {
                foreach ($arrPortalWidgets as $arrWidgetDetail) {
                    if ($arrWidgetDetail['W']['portal_id'] == $arrPortalDetail[0]['Portal']['career_portal_id']) {
                        if ($arrWidgetDetail['PW']['career_portal_theme_id'] == $arrPortalThemeDetail[0]['career_portal_theme']['career_portal_theme_id']) {
                            if ($arrWidgetDetail['W']['widget_name'] == "Job Search") {
                                echo $this->element("job_search", array('widget_id' => $arrWidgetDetail['W']['widget_id'], 'theme_id' => $arrPortalThemeDetail[0]['career_portal_theme']['career_portal_theme_id'], 'portal_id' => $arrWidgetDetail['W']['portal_id']));
                            }

                            if ($arrWidgetDetail['W']['widget_name'] == "Latest Jobs") {
                                echo $this->element("latest_jobs", array('widget_id' => $arrWidgetDetail['W']['widget_id'], 'theme_id' => $arrPortalThemeDetail[0]['career_portal_theme']['career_portal_theme_id'], 'portal_id' => $arrWidgetDetail['W']['portal_id']));
                            }

                            if ($arrWidgetDetail['W']['widget_name'] == "Contact Us") {
                                echo $this->element("portal_contact_us", array('widget_id' => $arrWidgetDetail['W']['widget_id'], 'theme_id' => $arrPortalThemeDetail[0]['career_portal_theme']['career_portal_theme_id'], 'portal_id' => $arrWidgetDetail['W']['portal_id']));
                            }
                        } else {
                            if ($arrWidgetDetail['W']['widget_name'] == "Job Search") {
                                echo $this->element("job_search", array('strHidden' => '1', 'widget_id' => $arrWidgetDetail['W']['widget_id'], 'theme_id' => $arrPortalThemeDetail[0]['career_portal_theme']['career_portal_theme_id'], 'portal_id' => $arrWidgetDetail['W']['portal_id']));
                            }

                            if ($arrWidgetDetail['W']['widget_name'] == "Latest Jobs") {
                                echo $this->element("latest_jobs", array('strHidden' => '1', 'widget_id' => $arrWidgetDetail['W']['widget_id'], 'theme_id' => $arrPortalThemeDetail[0]['career_portal_theme']['career_portal_theme_id'], 'portal_id' => $arrWidgetDetail['W']['portal_id']));
                            }

                            if ($arrWidgetDetail['W']['widget_name'] == "Contact Us") {
                                echo $this->element("portal_contact_us", array('strHidden' => '1', 'widget_id' => $arrWidgetDetail['W']['widget_id'], 'theme_id' => $arrPortalThemeDetail[0]['career_portal_theme']['career_portal_theme_id'], 'portal_id' => $arrWidgetDetail['W']['portal_id']));
                            }
                        }
                    }
                }
