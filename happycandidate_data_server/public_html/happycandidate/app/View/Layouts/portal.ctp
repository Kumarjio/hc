...
<body>
	...
	<?php
		echo $this->element("widgets_manage");
	?>
	...
	<div class="main-nav-panel padding-top-5">
			<div class="wrapper" id="logonamemenu" onmouseover="fnApplyEditorHoverCss(this);fnShowEditLogo();fnShowEditMenu()" onmouseout="fnRemoveEditorHoverCss(this);fnHideEditLogo();fnHideEditMenu()">
				<span>
				...
				<?php
					...
					{
						?>					
							<span id="add_menus_option" style="display:none;">Add Menus</span>
							<span style="font-size: 10px;position: relative;top:0px;display:none;cursor:pointer;vertical-align:top;" id="menuedit" onclick="fnShowMenuSection()">Manage</span>
							<?php
					...
					{
						?>
							<span id="add_menus_option">Add Menus</span>
							<span style="font-size: 10px;position: relative;top:0px;display:none;cursor:pointer;vertical-align:top;" id="menuedit" onclick="fnShowMenuSection()">Manage</span>
						<?php
					}
				?>
	...
	?>
	<!--Start Header -->
	<!--<div id="header-candy" onmouseover="fnApplyEditorHoverCss(this);fnShowHeaderImageSetter();" onmouseout="fnHideHeaderImageSetter();fnRemoveEditorHoverCss(this);">
		<span style="font-size: 10px;position: relative;top:0px;display:none;cursor:pointer;vertical-align:top;" id="header_image" onclick="fnShowBannerImageSection()">Add Banner Image</span>
			...
			if(isset($arrPortalWidgets) && (is_array($arrPortalWidgets)) && (count($arrPortalWidgets)>0))
			{
				foreach($arrPortalWidgets as $arrWidgetDetail)
				{
					if($arrWidgetDetail['PW']['career_portal_id'] == $arrPortalDetail[0]['Portal']['career_portal_id'] && $arrWidgetDetail['PW']['career_portal_theme_id'] == $arrPortalThemeDetail[0]['career_portal_theme']['career_portal_theme_id'])
					{
						...
						{
							echo $this->element("job_search",array('widget_id'=>$arrWidgetDetail['W']['widget_id'],'theme_id'=>$arrPortalThemeDetail[0]['career_portal_theme']['career_portal_theme_id'],'portal_id'=>$arrPortalDetail[0]['Portal']['career_portal_id']));
						}
						
						if($arrWidgetDetail['W']['widget_name'] == "Latest Jobs")
						{
							echo $this->element("latest_jobs",array('widget_id'=>$arrWidgetDetail['W']['widget_id'],'theme_id'=>$arrPortalThemeDetail[0]['career_portal_theme']['career_portal_theme_id'],'portal_id'=>$arrPortalDetail[0]['Portal']['career_portal_id']));
						}
						
						if($arrWidgetDetail['W']['widget_name'] == "Highlighted Jobs")
						{
							echo $this->element("highlighted_jobs",array('widget_id'=>$arrWidgetDetail['W']['widget_id'],'theme_id'=>$arrPortalThemeDetail[0]['career_portal_theme']['career_portal_theme_id'],'portal_id'=>$arrPortalDetail[0]['Portal']['career_portal_id']));
						}
						
						if($arrWidgetDetail['W']['widget_name'] == "Contact Us")
						{
							echo $this->element("portal_contact_us",array('widget_id'=>$arrWidgetDetail['W']['widget_id'],'theme_id'=>$arrPortalThemeDetail[0]['career_portal_theme']['career_portal_theme_id'],'portal_id'=>$arrPortalDetail[0]['Portal']['career_portal_id']));
						}
					}
					else
					{
						if($arrWidgetDetail['W']['widget_name'] == "Job Search")
						{
							echo $this->element("job_search",array('strHidden'=>'1','widget_id'=>$arrWidgetDetail['W']['widget_id'],'theme_id'=>$arrPortalThemeDetail[0]['career_portal_theme']['career_portal_theme_id'],'portal_id'=>$arrPortalDetail[0]['Portal']['career_portal_id']));
						}
						
						if($arrWidgetDetail['W']['widget_name'] == "Latest Jobs")
						{
							echo $this->element("latest_jobs",array('strHidden'=>'1','widget_id'=>$arrWidgetDetail['W']['widget_id'],'theme_id'=>$arrPortalThemeDetail[0]['career_portal_theme']['career_portal_theme_id'],'portal_id'=>$arrPortalDetail[0]['Portal']['career_portal_id']));
						}
						
						if($arrWidgetDetail['W']['widget_name'] == "Highlighted Jobs")
						{
							echo $this->element("highlighted_jobs",array('strHidden'=>'1','widget_id'=>$arrWidgetDetail['W']['widget_id'],'theme_id'=>$arrPortalThemeDetail[0]['career_portal_theme']['career_portal_theme_id'],'portal_id'=>$arrPortalDetail[0]['Portal']['career_portal_id']));
						}
						
						if($arrWidgetDetail['W']['widget_name'] == "Contact Us")
						{
							echo $this->element("portal_contact_us",array('strHidden'=>'1','widget_id'=>$arrWidgetDetail['W']['widget_id'],'theme_id'=>$arrPortalThemeDetail[0]['career_portal_theme']['career_portal_theme_id'],'portal_id'=>$arrPortalDetail[0]['Portal']['career_portal_id']));
						}
					}
				}
			}
	...
	<?php
		if(isset($arrCoursesDetails) && is_array($arrCoursesDetails) && (count($arrCoursesDetails)>0))
		{
			?>
						...
						<ul class="service-con">
							<?php
								foreach($arrCoursesDetails as $arrCourse)
								{
									...
									?>
										<li><h3>Elearning - <a href="javascript:void(0);"><?php echo $objCourse->fullname; ?></a></h3>
										<label></label>
