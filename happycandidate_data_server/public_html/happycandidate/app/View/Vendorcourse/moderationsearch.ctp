...
<div class="sub-header index row"><h2>Moderated Course</h2></div>
<div class="index row" style="width:100%;float:left;">
	<div class="col-md-12" style="width:100%;float:left;">
		<?php
			$strProductSearchUrl = Router::url(array('controller'=>'vendorcourse','action'=>'moderation'),true);
		?>
				...
				foreach($arrProductList as $arrContent)
				{
					...
					?>
						<tr id="product_list_<?php echo $arrContent['products']['productd_id'];?>">
						  ...
						  <td><a onclick="fnConfirmInquiryDelete('<?php echo $arrContent['products']['productd_id'];?>')" href="javascript:void(0);">Delete</a></td>
						</tr>
					<?php
				}
			}
