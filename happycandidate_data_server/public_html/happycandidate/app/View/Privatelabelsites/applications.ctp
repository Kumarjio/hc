...
<div class="page-content-wrapper employers-type" style="min-height:500px;">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h1>Applications</h1>
				<p>Listed are the job seekers who have applied for your open jobs that you have added to your Career Portal.</p>
					...
					if(is_array($arrApplications) && (count($arrApplications)>0))
					{
						...
						<div class="tab-row-container">
							<div class="panel panel-default hidden-xs hidden-sm">
								...
								<table id="sorting_list" class="tablesorter">
									<thead>
									<tr>
										<th><input type="checkbox" value=""></th>
										<th>Title</th>
										<th class="selected">Candidate</th>
										<th>Email</th>
										<th>Phone Number</th>
										<th class="no-filter">Resume | CV</th>
