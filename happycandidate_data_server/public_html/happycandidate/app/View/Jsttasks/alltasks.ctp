<?php
	$strAddUrl = Router::url(array('controller'=>'jsttasks','action'=>'add',$intPortalId),true);
	$strTodaysTasksUrl = Router::url(array('controller'=>'jsttasks','action'=>'index',$intPortalId),true);
	$strCompletedUrl = Router::url(array('controller'=>'jsttasks','action'=>'completedtasks',$intPortalId),true);
?>
<div class="wrapper">
	<div id="jop_search" class="jop_search">
		<h2 id="jobn" style="padding:0;margin-bottom:30px;background:none;padding:none;">Job Seeker All Tasks</h2>
		...
		<div style="float:left;width:100%;">
			...
			<a style="float:right;margin-right:10px;" href="<?php echo $strTodaysTasksUrl; ?>" name="all_tasks" id="all_tasks" class="button_class">Today's  Tasks</a>
			<a style="float:right;margin-right:10px;" href="<?php echo $strCompletedUrl; ?>" name="all_tasks" id="all_tasks" class="button_class">Completed Tasks</a>
			<a style="float:right;margin-right:10px;" href="<?php echo $strAddUrl; ?>" name="add_contact_but" id="add_contact_but" class="button_class">Add Tasks</a>
		</div>
		<?php
			echo $this->element('filter_tasks');
		?>
		<div style="float:left;width:100%;">&nbsp;</div>
		<div style="float:left;width:100%;">&nbsp;</div>
		<?php
			echo $this->element('delete_tasks');
					...
					?>
						<div style="width:95%;border:none;" class="line_up_td" id="contact">
							...
							<div style="width:20%;" class="line_up_title">
								<a title="<?php echo $arrAppointment['JstAppointments']['jstappointments_contact_fname']; ?>" href="javascript:void(0);">Task With</a>
							</div>
				...
				else
				{
					?>
						<div id="contact_message" style="float:left;width:100%;">
							<strong>You don't have any tasks added to your list for today, Please add one</strong>
						</div>
					<?php
				}
			?>
