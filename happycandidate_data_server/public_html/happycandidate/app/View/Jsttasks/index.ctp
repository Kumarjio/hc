<?php
	...
	$strAllTasksUrl = Router::url(array('controller'=>'jsttasks','action'=>'alltasks',$intPortalId),true);
...
<div class="wrapper">
	<div id="jop_search" class="jop_search">
		<h2 id="jobn" style="padding:0;margin-bottom:30px;background:none;padding:none;">Job Seeker Today's Tasks</h2>
		...
		<div style="float:left;width:100%;">
			...
			<a style="float:right;margin-right:10px;" href="<?php echo $strAllTasksUrl; ?>" name="all_tasks" id="all_tasks" class="button_class">All Tasks</a>
