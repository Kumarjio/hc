...
<div class="wrapper">
	<div id="portal_registration">
		<h2 id="jobn" style="padding:0;margin-bottom:30px;background:none;padding:none;">Job Seeker tasks</h2>
		<input type="hidden" name="portal_id" id="portal_id" value="<?php echo $intPortalId; ?>" />
		<div style="float:left;width:100%;">
			<a style="float:right;margin-right:10px;" id="contact_jsp_<?php echo $arrAppointmentList[0]['JstTasks']['jsttasks_id']; ?>" onclick="fnDeleteContact(this,'1')" href="javascript:void(0);" name="add_contact_but" class="button_class">Delete</a>
			<a style="float:right;margin-right:10px;" id="contact_delete_<?php echo $arrAppointmentList[0]['JstTasks']['jsttasks_id']; ?>" href="<?php echo $strJobSearchProcessUrl; ?>" name="add_contact_but" class="button_class">Return To Job Search Process</a>
			<a style="float:right;margin-right:10px;" id="contact_edit_<?php echo $arrAppointmentList[0]['JstTasks']['jsttasks_id']; ?>" onclick="fnShowEditForm(this,'1')" href="javascript:void(0);" name="add_contact_but" class="button_class">Edit</a>
		...
		<div id="contacts_container" class="line_up_table" style="float:left;width:100%;">
			...
			<div id="detail_appointment" style="float:left;width:100%;">
				<?php
					echo $this->element('tasks_detail');
				?>
			</div>
			<div style="float:left;width:100%;">&nbsp;</div>
			<div style="float:left;width:100%;">&nbsp;</div>
