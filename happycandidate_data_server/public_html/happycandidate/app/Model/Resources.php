...
//                        echo '<pre>';print_r($conditions);
			if(is_array($conditions) && (count($conditions)>0))
			{
                                ...
                                {
                                    $strProductListQueryWhereClause = " WHERE products.product_parent = '".$conditions['parent_id']."' AND ";
                                }else{
                                    $strProductListQueryWhereClause = " WHERE products.product_parent IS NULL AND ";
                                }
				...
				if(isset($conditions['category']))
				{
					...
					$strProductListQuery = $strProductListQuery.$strProductListQueryWhereClause4;
                                ...
                                if($conditions['product_type'] == 'Course')
				{
					$strProductListQueryWhereClause3 = " (products.product_type = 'Course' OR products.product_type = 'SkillSoftcourse')";
					$strProductListQuery = $strProductListQuery.$strProductListQueryWhereClause3;
				}
                                                                
                                if($conditions['product_type'] == 'Services')
				{
//					$strProductListQueryWhereClause3 = " products.product_type != 'Course'";
					$strProductListQueryWhereClause3 = " (products.product_type ='Services' OR products.product_type ='Product')";
					$strProductListQuery = $strProductListQuery.$strProductListQueryWhereClause3;
				}
				...
				if(isset($conditions['created_by']))
				{
					...
					{
						$strProductListQueryWhereClause3 = " AND products.created_by = '".$conditions['created_by']."'";
						$strProductListQuery = $strProductListQuery.$strProductListQueryWhereClause3;
					}
				}
				
				if(isset($conditions['product_publish_status']))
				{
					if($conditions['product_publish_status'] == '1')
					{
						$strProductListQueryWhereClause3 = " AND products.product_publish_status = '1'";
						$strProductListQuery = $strProductListQuery.$strProductListQueryWhereClause3;
					}
				}
				
				if(isset($conditions['product_draft_status']))
				{
					if($conditions['product_draft_status'] == '1')
					{
						$strProductListQueryWhereClause3 = " AND products.product_draft_status = '1'";
						$strProductListQuery = $strProductListQuery.$strProductListQueryWhereClause3;
					}
				}
				
				if(isset($conditions['product_moderation_status']))
				{
					if($conditions['product_moderation_status'] == '1')
					{
						$strProductListQueryWhereClause3 = " AND products.product_moderation_status = '1'";
						$strProductListQuery = $strProductListQuery.$strProductListQueryWhereClause3;
					}
				}
...
//                                $strProductListQueryWhereClause5 = " AND products.product_parent = ''";
//                                $strProductListQuery = $strProductListQuery.$strProductListQueryWhereClause5;
			}
...
//					$strProductListQueryWhereClause3 = " products.product_type != 'Course'";
				...
				if(isset($conditions['product_draft_status']))
				{
					if($conditions['product_draft_status'])
					{
						$strProductListQueryWhereClause3 = " AND products.product_draft_status = '1'";
						$strProductListQuery = $strProductListQuery.$strProductListQueryWhereClause3;
					}
				...
				if(isset($conditions['product_moderation_status']))
				{
					if($conditions['product_moderation_status'])
					{
						$strProductListQueryWhereClause3 = " AND products.product_moderation_status = '1'";
						$strProductListQuery = $strProductListQuery.$strProductListQueryWhereClause3;
					}
		...
		{
			$strProductListQuery = "SELECT Resources.*,Vendorservice.*,Vendors.* FROM products AS Resources,vendor_service AS Vendorservice,vendors AS Vendors WHERE Resources.product_publish_status = '1' AND Resources.productd_id = Vendorservice.service_id AND Vendorservice.vendor_id = Vendors.vendor_id";
			//echo $strProductListQuery;exit;
			$arrProductContentArray = $this->query($strProductListQuery);
			return $arrProductContentArray;
		}
		...
		public function fnGetContentList($intCatId,$intContentType = "",$intContForUser = "3")
		{
			...
			else
			{
                ...
                public function fnGetPublishCourseSortList($columnName="",$sort="")
		{
			$strProductListQuery = "SELECT * FROM products WHERE product_type = 'Course' OR product_type ='SkillSoftcourse' AND product_publish_status = '1' ORDER BY $columnName ".$sort." LIMIT 20";
			$arrProductContentArray = $this->query($strProductListQuery);
			return $arrProductContentArray;
		}
	}
