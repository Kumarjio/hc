<?php
	class Vendorfiles extends AppModel 
	{
		public $name = 'Vendorfiles';
		public $useTable = 'vendor_updates_file';
		...
		public function paginate($conditions, $fields, $order, $limit, $page = 1,$recursive = null, $extra = array()) 
		{
			...
			$strProductListQueryFromcClause = " FROM product_images";
			...
			if(is_array($conditions) && (count($conditions)>0))
			{
				...
				if($conditions['product_image'])
				{
					$strProductListQueryWhereClause3 = " product_images.product_image LIKE '%".$conditions['product_image']."%'";
					$strProductListQuery = $strProductListQuery.$strProductListQueryWhereClause3;
				}
			}
			$strProductListQuery .= " ORDER BY product_images_id ASC";
