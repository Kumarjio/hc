<?php
	class Vendors extends AppModel 
	{
		public $name = 'Vendors';
		...
		public function paginate($conditions, $fields, $order, $limit, $page = 1,$recursive = null, $extra = array()) 
		{
			...
			/*print("<pre>");
			print_r($conditions);*/
			$strProductListQueryStart = "SELECT vendors.*,vendor_company_details.*";
			$strProductListQueryFromcClause = " FROM vendors LEFT JOIN vendor_company_details ON vendors.vendor_id = vendor_company_details.vendor_id";
			...
			if(is_array($conditions) && (count($conditions)>0))
			{
				...
				if($conditions['parent_vendor'])
				{
					//echo "hi";exit;
					$strProductListQueryWhereClause4 = " vendors.parent_vendor = '0'";
				...
				if($conditions['vendor_first_name'])
				{
					$strProductListQueryWhereClause3 = " AND vendors.vendor_first_name LIKE '%".$conditions['vendor_first_name']."%'";
					$strProductListQuery = $strProductListQuery.$strProductListQueryWhereClause3;
				}
				
				
			}
			$strProductListQuery .= " ORDER BY vendor_company_details.company_name ASC";
		...
		public function paginateCount($conditions = null, $recursive = 0,$extra = array()) 
		{
			...
			//exit;
			// method body
			$strProductListQueryStart = "SELECT vendors.*";
			$strProductListQueryFromcClause = " FROM vendors LEFT JOIN vendor_company_details ON vendors.vendor_id = vendor_company_details.vendor_id";
			$strProductListQuery = $strProductListQueryStart.$strProductListQueryFromcClause;
			if(is_array($conditions) && (count($conditions)>0))
			{
