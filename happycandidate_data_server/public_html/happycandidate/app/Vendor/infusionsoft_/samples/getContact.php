...
$infusionsoft = new \Infusionsoft\Infusionsoft(array(
    ...
    'redirectUri' => 'http://localhost/infusionsoft/samples/getContact.php',
));
...
function getContact($infusionsoft) {
    $contact = array('FirstName' => 'TESTJohn', 'LastName' => 'TESTDoe', 'Email' => 'testjohndoe@mailinator.com');

    return  $infusionsoft->data->findByField("Contact",1,0,"FirstName","TESTJohn", array('Id', 'FirstName', 'LastName', 'Email'));
}

if ($infusionsoft->getToken()) {
    try {
        $contact = getContact($infusionsoft);
