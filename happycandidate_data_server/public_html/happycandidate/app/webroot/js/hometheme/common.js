...
$(document).ready(function(){		var windowH = $(window).height(); 			var headerH = $('#page-header').height(); 			var sideH = windowH - headerH;				$('.container-layout').css({'minHeight':sideH ,'margin-bottom':-20 });				var winH = $(window).height();		$('.edit-panel').css({'height':winH-54})		});