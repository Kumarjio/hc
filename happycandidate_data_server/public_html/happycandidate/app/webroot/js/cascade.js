...
function fnGetLocationDetailFromZipFrontCovEmp()
{
	var strZipCode = $('#txt_post_code').val();
	$('.cms-bgloader-mask').show();//show loader mask
	$('.cms-bgloader').show(); //show loading image
			
	var datastr = 'zip='+strZipCode+"&ref=1";
	$('#loader').show();
	$.ajax({ 
			type: "POST",
			...
			success: function(data)
			{
				if(data.status == "success")
				{
					if(data.countrycd != "")
					{
						$('#txt_emp_country_ref').val(data.countrycd);
					}
					else
					{
						$('#txt_emp_country_ref').val("");
					}
					if(data.state != "")
					{
						$('#txtempstateprovinceref').val(data.state);
					}
					else
					{
						$('#txtempstateprovinceref').val("");
					}
					
					if(data.city != "")
					{
						$('#txtempcountyref').val(data.city);
					}
					else
					{
						$('#txtempcountyref').val("");
					...
					if(data.locality != "")
					{
						$('#emplocalityvalref').val(data.locality);
					}
					else
					{
						$('#emplocalityvalref').val("");
					}
				}
				$('#loader').hide();
				//$('#country').show();
				...
				$('#county_emp_auto_ref').css('display','block');
				$('#city_emp_auto_ref').css('display','block');
...
function fnGetLocationDetailFromZipFrontCov()
{
	var strZipCode = $('#txt_post_code').val();
	$('.cms-bgloader-mask').show();//show loader mask
	$('.cms-bgloader').show(); //show loading image
	...
	$.ajax({ 
			...
			success: function(data)
			{
				if(data.status == "success")
				{
					if(data.countrycd != "")
					{
						$('#txt_your_country_ref').val(data.countrycd);
					}
					else
					{
						$('#txt_your_country_ref').val("");
					}
					if(data.state != "")
					{
						$('#txtyourstateprovinceref').val(data.state);
					}
					else
					{
						$('#txtyourstateprovinceref').val("");
					}
					
					if(data.city != "")
					{
						$('#txtyourcountyref').val(data.city);
					}
					else
					{
						$('#txtyourcountyref').val("");
					}
					if(data.locality != "")
					{
						$('#yourlocalityvalref').val(data.locality);
					}
					else
					{
						$('#yourlocalityvalref').val("");
					}
				}
				$('#loader').hide();
				//$('#country').show();
				...
				$('#city_your_auto_ref').css('display','block');
				$('#county_your_auto_ref').css('display','block');
...
function fnGetLocationDetailFromZipFrontRef()
{
	var strZipCode = $('#txt_post_code').val();
	$('.cms-bgloader-mask').show();//show loader mask
	$('.cms-bgloader').show(); //show loading image
	...
	$.ajax({ 
			...
			success: function(data)
			{
				if(data.status == "success")
				{
					if(data.countrycd != "")
					{
						$('#txt_country_ref').val(data.countrycd);
					}
					else
					{
						$('#txt_country_ref').val("");
					...
					if(data.state != "")
					{
						$('#txtstateprovinceref').val(data.state);
					}
					else
					{
						$('#txtstateprovinceref').val("");
					}
					
					if(data.city != "")
					{
						$('#txtcountyref').val(data.city);
					}
					else
					{
						$('#txtcountyref').val("");
					...
					if(data.locality != "")
					{
						$('#localityvalref').val(data.locality);
					}
					else
					{
						$('#localityvalref').val("");
				...
				$('#city_auto_ref').css('display','block');
				$('#county_auto_ref').css('display','block');
...
function fnGetLocationDetailFromCountryCovEmp()
{
...
function fnGetLocationDetailFromCountryCov()
{
	var country = $( "#txt_country option:selected" ).text();
...
function fnGetLocationDetailFromCountryRef()
{
	var country = $( "#txt_country option:selected" ).text();
