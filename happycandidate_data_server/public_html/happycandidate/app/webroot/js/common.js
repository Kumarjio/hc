...
function fnShowfirstTestimonial(){
	...
	//$("#fistTestimonial").show('slide', {direction: 'left'});
	$("#fistTestimonial").toggle( "slide" );
...
function fnShowsecondTestimonial(){
	...
	$("#secondTestimonial").toggle( "slide" );
	$("#thirdTestimonial").hide();
