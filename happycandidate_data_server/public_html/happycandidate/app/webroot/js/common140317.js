...
$(document).ready(function(){	
	if(window.location.href.indexOf("49")>0)
		{console.log($('#portal_id').val())

	console.log($('#currentstep').val())
			fnGetSubstepDetail(5,50,49,18);
		}if(window.location.href.indexOf("74")>0)
		{ 
			fnGetSubstepDetail(5,75,74,19);
		}
