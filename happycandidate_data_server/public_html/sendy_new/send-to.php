        ...
        <?php if (get_app_info('is_sub_user')): ?>
            <?php if (paid()): ?>
                ...
                <?php else: ?>
                    ...
                    if ($aws_keys_available == 'true' && (get_app_info('send_rate') == '' || get_app_info('send_rate') == 0))
                        mysqli_query($mysqli, 'UPDATE login SET send_rate = ' . $ses_send_rate);
                    ...
                    if (get_app_info('is_sub_user')) {
                        ...
                        if ($brand_monthly_quota != -1) {
                            ...
                            if ($date_today_unix >= $date_on_reset_unix) {
                                ...
                                if ($day_today >= $brand_limit_resets_on)
                            ...
                            $ses_sends_left = -1; //unlimited sending
                    }
                    else {
                        if ($aws_keys_available == 'true')
                    ...
                    <?php else: ?>
                        ...
                        <strong><?php echo _('Recipients'); ?></strong>: <span id="recipients">0</span> <?php echo $aws_keys_available == 'true' ? _('of') : ''; ?> <?php
                        echo $aws_keys_available == 'true' ? $ses_sends_left : '';
                        echo _(' remaining');
                        ?><br/>
                        ...
                        if ($aws_keys_available == 'true') {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    echo '<p class="error">' . _('Error') . ' ($sns->CreateTopic(\'bounces\')): ' . $e->getMessage() . '. ' . _('Please try again by refreshing this page. If this error persist, visit your Amazon SNS console and delete all \'Topics\' and \'Subscriptions\' and try again.') . "<br/><br/></p>";
                                }
                                ...
                                try {
                                    ...
                                    echo '<p class="error">' . _('Error') . ' ($sns->CreateTopic(\'complaints\')): ' . $e->getMessage() . '. ' . _('Please try again by refreshing this page. If this error persist, visit your Amazon SNS console and delete all \'Topics\' and \'Subscriptions\' and try again.') . "<br/><br/></p>";
                                }
                                ...
                                if ($bounces_topic_arn != '' && $complaints_topic_arn != '') {
                                    ...
                                    try {
                                        $bounces_subscribe_endpoint = $sns->Subscribe($bounces_topic_arn, $protocol, get_app_info('path') . '/includes/campaigns/bounces.php');
                                    } catch (SNSException $e) {
                                    ...
                                    try {
                                        ...
                                        echo '<p class="error">' . _('Error') . ' ($sns->Subscribe(\'complaints\')): ' . $e->getMessage() . '. ' . _('Please try again by refreshing this page. If this error persist, visit your Amazon SNS console and delete all \'Topics\' and \'Subscriptions\' and try again.') . "<br/><br/></p>";
                                    }
                                } else
                                    echo '<p class="error">' . _('Error: Unable to create bounces and complaints SNS topics, please try again by refreshing this page.') . "<br/><br/></p>";
...
<?php if ($_SESSION[$_SESSION['license']] != hash('sha512', $_SESSION['license'] . '2ifQ9IppVwYdOgSJoQhKOHAUK/oPwKZy')) : ?>
                                                if (confirm("Hi! This is Ben, the indie developer of Sendy. Please consider supporting my tireless efforts in developing this software you are using by purchasing a copy of Sendy at sendy.co. I really appreciate your support. Thank you and God bless!"))
                                                    window.location = "https://sendy.co";
                                                else
                                                    window.location = "https://sendy.co";
<?php else: ?>
