...
//            $html = str_replace('[firstname]', 'Arjun', $html);
//            $html = str_replace('[lastname]', 'Gunjal', $html);
//            $html = str_replace('[Name]', 'Arjun Gunjal', $html);
//            $html = str_replace('[Email]', $from_email, $html);
//            $html = str_replace('[phonenumber]','12345679890', $html);
//            $html = str_replace('[zipcode]','123456', $html);
//            $html = str_replace('[state]','Maharashtra', $html);
//            $html = str_replace('[city]','Pune', $html);
//            $html = str_replace('[country]','IN', $html);
//            $html = str_replace('[portal_url]','monster.com', $html);
//            $html = str_replace('[owner_company_name]','ROT', $html);
//            $html = str_replace('[username]','gunjalarjun05', $html);
//            $html = str_replace('[forgot_password_link]','testlink.com', $html);
    ...
    //otherwise, replace custom field tag
        ...
        if ($r5) {
            ...
            for ($j = 0; $j < $cf_count; $j++) {
                ...
                if ($field == $key) {
                    if (array_key_exists($j, $custom_values_array))
                        $cva = $custom_values_array[$j];
                    else
                        $cva = '';
